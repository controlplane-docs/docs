...
<CardGroup cols={2}>
  <Card title="PostgreSQL template" icon="database" href="/template-catalog/templates/postgres" horizontal>
    Every value of the template, plus pooling, backups, and restores.
  </Card>
  <Card title="Create your own secrets" icon="key" href="/guides/create-secret/overview" horizontal>
