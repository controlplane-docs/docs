...
Map your own domain to your workload: verify your apex domain, route a subdomain to the workload, and get TLS certificates issued and renewed automatically.
...
Add the displayed TXT record to your DNS provider and wait for it to propagate.
</Step>
...
<Note>
Control Plane provisions TLS certificates automatically after the DNS propagates and your workload is ready.
</Note>
...
The command returns an error listing the TXT records that prove ownership. Add one of them to your DNS provider, wait for it to propagate, then run the command again:
...
The output lists the TXT record that proves ownership. Add it to your DNS provider, wait for it to propagate, then run `terraform apply` again to create the domain.
...
The output lists the TXT record that proves ownership. Add it to your DNS provider, wait for it to propagate, then run `pulumi up` again to create the domain.
...
After DNS propagates and the certificate is issued, open `https://app.example.com` in your browser. Your application loads over HTTPS with a valid TLS certificate.
