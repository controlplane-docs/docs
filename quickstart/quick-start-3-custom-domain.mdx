...
<Note>
Remove the DNS records from your DNS provider after deleting the domain. A `--remote` build also pushes the build cache image `frontend-cache:latest`; delete that too if you built without Docker.
</Note>
