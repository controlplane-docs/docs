...
Once the certificate is issued, open `https://example.com` in your browser. Your application loads over HTTPS with a valid TLS certificate, and its footer still names the [location](/concepts/location) that served the request.
