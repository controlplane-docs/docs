...
Under `Endpoints`, click the link next to `Canonical Endpoint (Global)`. Your application displays the Control Plane environment variables, including the location and provider.
</Step>
