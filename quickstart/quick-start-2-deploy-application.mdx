...
Build and deploy your own application to Control Plane: containerize a sample Node.js application, push it to your org's private image registry, and run it as a workload.
...
Once the workload reports `Ready`, open its canonical endpoint; the page lists the runtime environment variables Control Plane injects, including `CPLN_PROVIDER` and `CPLN_LOCATION` for the location that served your request.
