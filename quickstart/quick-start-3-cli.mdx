...
The default browser will launch displaying the login page. Select the single sign-on (SSO) provider that is connected to your email address. After a successful log in, the browser can be closed. The shell will display the [profile](/guides/manage-profile) named `default` that was created and mapped to your email address.
