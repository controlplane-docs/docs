...
[Actuator Settings](/self-hosted/byok/settings/actuator)
...
Configuration for Middlebox, required for the [Cloud Wormhole agent](/objects/agent) to work with BYOK location.
