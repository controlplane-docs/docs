...
description: REST API reference for Control Plane covering Core and Audit APIs, Bearer token authentication, service account keys, and user access tokens.
keywords: ['rest', 'http', 'endpoints', 'curl', 'bearer token', 'authentication', 'service account key', 'user access token', 'core api', 'audit api', 'api.cpln.io', 'openapi', 'swagger', 'pagination', 'profile token']
---
