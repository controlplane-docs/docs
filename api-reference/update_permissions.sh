...
# IMPORTANT: Execute the following before running: cpln profile update default --org demo-cpln-organization

GENERATE=(agent auditctx cloudaccount domain group gvc identity image location org policy quota secret serviceaccount user volumeset workload)
