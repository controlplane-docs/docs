...
- **Minor Changes**
  ...
  - Add `--repo` flag to install/upgrade helm charts from OCI registries or Helm repositories. Refer to the [cpln helm](/cli-reference/guides/cpln-helm#install-from-remote-repositories) guide for more info.
