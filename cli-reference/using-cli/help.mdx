...
<Tip>Use `--help` frequently to discover available subcommands, required parameters, and optional flags.</Tip>
...
- [Browser-less CLI Login](/cli-reference/guides/browser-less-cli-login) - Authenticate without a browser
- [Profiles](/cli-reference/get-started/profiles) - Configure and manage CLI profiles

### Deploying applications

- [Compose Deploy](/cli-reference/guides/compose-deploy) - Deploy applications using Docker Compose
- [cpln apply](/cli-reference/guides/cpln-apply) - Apply configuration files to create or update resources
- [cpln delete](/cli-reference/guides/cpln-delete) - Delete resources using configuration files

### Working with workloads

- [Workload Connect](/cli-reference/guides/workload-connect) - Interact with running workload containers
- [Workload Exec](/cli-reference/guides/workload-exec) - Execute commands in workload containers
- [Workload Run](/cli-reference/guides/workload-run) - Run one-off commands in a new workload instance

### Kubernetes integration

- [cpln operator](/cli-reference/guides/cpln-operator) - Manage the Kubernetes secret used by the Control Plane operator
- [cpln helm](/cli-reference/guides/cpln-helm) - Manage Control Plane resources using Helm charts
- [cpln port-forward](/cli-reference/guides/cpln-port-forward) - Forward local ports to workloads running in a GVC

### Advanced operations

- [cpln convert](/cli-reference/guides/cpln-convert) - Convert Kubernetes manifests to Control Plane format
- [cpln cp](/cli-reference/guides/cpln-cp) - Copy files to and from workloads
