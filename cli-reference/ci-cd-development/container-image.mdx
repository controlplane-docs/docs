...
keywords: ['docker build', 'image build', 'multi-stage', 'dockerfile', 'oci image', 'buildpack', 'cpln image build', 'cron workload', 'automation container', 'alpine']
---
...
<Tab title="Binary (lightweight)">
  ...
  # Pin the CLI version for reproducible builds
  ARG CPLN_BINARY_URL=https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/2599494602-c2e8e568/cpln-linux.tgz
