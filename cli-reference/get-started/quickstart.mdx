...
<Step title="Create a GVC">
  ...
  <Tip>
  Locations are not limited to public cloud regions. Bare-metal servers, on-premises VMs, and your own Kubernetes clusters can be registered as locations and used here in exactly the same way. See [Deploy a Workload to Your Own Hardware](/guides/deploy-to-your-own-hardware).
  </Tip>
</Step>
