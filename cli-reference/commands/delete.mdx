---
title: delete
description: "cpln delete — Delete resources defined in input files."
keywords: ['cpln delete', 'kubectl delete', 'remove resource', 'delete manifest', 'cpln delete --file', 'destroy resource', 'cleanup', 'delete yaml', 'bulk delete']
---
