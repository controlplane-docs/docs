...
```text Output
{
  ...
  "created": "2026-08-12T13:35:26.556Z",
  "key": "sWRt5J1LPYU9nQYg.ZGVtby1jcGxuLW9yZ2FuaXphdGlvbi5kZW1vLXNlcnZpY2UtYWNjb3VudC5qaVZENFFMYzFBQXVScDB5a3YvTDliQ0V5ZURMWnRKVWNSaWE1N1kyVHY0PQ.FHIin0_tOeCyV1ZGLf88CI8xCcroEp10mxtKPUkPMJo"
}
```
...
|demo-service-account       |demo-service-account                     |5 minutes ago |default |sWRt5J1LPYU9nQYg |drink="water" |
...
```bash Command
cpln serviceaccount remove-key demo-service-account --key sRPtzpsUjJcFuWzA --org demo-cpln-organization
```
