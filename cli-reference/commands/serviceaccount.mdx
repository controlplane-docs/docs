...
```text Output
{
  ...
  "created": "2026-04-04T00:53:58.771Z",
  "key": "s4nIYs5GHDL0zy68.ZGVtby1jcGxuLW9yZ2FuaXphdGlvbi5kZW1vLXNlcnZpY2UtYWNjb3VudC42M0xCbU44SWxzVFFqMlVNNm9RMnlrbmJrbytCZGorUHJUUDY2VVB1Z3FNPQ.bHUMehulGnnshj059n0tD43G43QDebLrpqlHLmKe3ho"
}
```
...
|demo-service-account       |demo-service-account                     |9 minutes ago |default |s4nIYs5GHDL0zy68 |drink="water" |
...
```bash Command
cpln serviceaccount remove-key demo-service-account --key sIQi9pzzIW9DrOpI --org demo-cpln-organization
```
