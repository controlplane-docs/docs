...
```text Output
{
  ...
  "created": "2026-07-14T20:19:29.384Z",
  "key": "sWazilNSvMnEIFlo.ZGVtby1jcGxuLW9yZ2FuaXphdGlvbi5kZW1vLXNlcnZpY2UtYWNjb3VudC50WUFRM0IwdlNWbW01clhQM1EyWkwrVTZOa0NkZmdIR3h0NnNVSExmczhnPQ.cPtMQ7MESeEV2IUwaKDEyv4s_Fmcpf9aOzSpM-MfbT0"
}
```
...
|demo-service-account       |demo-service-account                     |9 minutes ago |default |sWazilNSvMnEIFlo |drink="water" |
...
|NAME                 |DESCRIPTION          |CREATED        |ORIGIN  |KEYS             |TAGS          |
|---------------------|---------------------|---------------|--------|-----------------|--------------|
|demo-service-account |demo-service-account |10 minutes ago |default |sWazilNSvMnEIFlo |drink="water" |
+---------------------+---------------------+---------------+--------+-----------------+--------------+
```
...
```bash Command
cpln serviceaccount remove-key demo-service-account --key sFQqFZsUqoVH3E4Y --org demo-cpln-organization
```
