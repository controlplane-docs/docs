...
```text Output
{
  ...
  "created": "2026-06-15T19:10:28.955Z",
  "key": "so4Ap02V1iCnoMzM.ZGVtby1jcGxuLW9yZ2FuaXphdGlvbi5kZW1vLXNlcnZpY2UtYWNjb3VudC5TeEdlMzZBaFFvN1FZckdZaURQM21BM2ZzK3ZtdS91YWpScklNbUhtZzg0PQ.e6lvupRng52SDedlEH_ik7hmZccof5ieQzJoklY7Zmo"
}
```
...
|demo-service-account       |demo-service-account                     |7 minutes ago |default |so4Ap02V1iCnoMzM |drink="water" |
...
|NAME                 |DESCRIPTION          |CREATED       |ORIGIN  |KEYS             |TAGS          |
|---------------------|---------------------|--------------|--------|-----------------|--------------|
|demo-service-account |demo-service-account |8 minutes ago |default |so4Ap02V1iCnoMzM |drink="water" |
+---------------------+---------------------+--------------+--------+-----------------+--------------+
```
...
```bash Command
cpln serviceaccount remove-key demo-service-account --key sOhnzzIkv05L8weI --org demo-cpln-organization
```
