...
```text Output
{
  ...
  "created": "2026-03-16T19:15:25.517Z",
  "key": "sUtxDww8SDloFdzw.ZGVtby1jcGxuLW9yZ2FuaXphdGlvbi5kZW1vLXNlcnZpY2UtYWNjb3VudC44ZVNpaWVKSHlLYkdCMHdHUGFVcWkrNkVTSU1MRE9TL1NHckVhTFplNXdnPQ.GobrujlCfE6pcfoz6LJq_tiz4k2nKZRtxrYqM5QtkDM"
}
```
...
|demo-service-account       |demo-service-account                     |9 minutes ago |default |sUtxDww8SDloFdzw |drink="water" |
...
```bash Command
cpln serviceaccount remove-key demo-service-account --key sizsu17Rv4f8YBGA --org demo-cpln-organization
```
