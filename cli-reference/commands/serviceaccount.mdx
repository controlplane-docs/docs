...
```text Output
{
  ...
  "created": "2025-12-20T03:40:46.207Z",
  "key": "sbzhJSM0qp9E3lKU.ZGVtby1jcGxuLW9yZ2FuaXphdGlvbi5kZW1vLXNlcnZpY2UtYWNjb3VudC45dzA5Nkgva3M5ZkFPVDZSYzVuZ3ZETUJWQjY2U3Z3WFRtbDVnVk9CQkdFPQ.MKDHFugZSn267JjWG5srxytvSVWpxJUpWc0eI3L8m9Q"
}
```
...
|demo-service-account       |demo-service-account                     |18 minutes ago |default |sbzhJSM0qp9E3lKU |drink="water" |
...
```bash Command
cpln serviceaccount remove-key demo-service-account --key s6bf5xU3lxKVsmzU --org demo-cpln-organization
```
