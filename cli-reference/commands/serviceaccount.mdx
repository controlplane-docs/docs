...
```text Output
{
  ...
  "created": "2026-02-06T18:34:35.874Z",
  "key": "sZHvbwgbG7XfSPw8.ZGVtby1jcGxuLW9yZ2FuaXphdGlvbi5kZW1vLXNlcnZpY2UtYWNjb3VudC56TkZ0cnhYM1MzeUNRdDkxeXhvSUN2ZE5EV3g5YmxIWVV5cmFOY2hYTWlZPQ.aV039I97NDyrnXwMlUXnJPV9UB3uDgPZIy75jHLuclI"
}
```
...
|demo-service-account       |demo-service-account                     |9 minutes ago |default |sZHvbwgbG7XfSPw8 |drink="water" |
...
```bash Command
cpln serviceaccount remove-key demo-service-account --key s4WwWFGwsbFlcahA --org demo-cpln-organization
```
