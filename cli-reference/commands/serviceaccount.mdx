...
```text Output
{
  ...
  "created": "2026-07-15T10:22:02.975Z",
  "key": "sB0jM2ZVtShYb0eg.ZGVtby1jcGxuLW9yZ2FuaXphdGlvbi5kZW1vLXNlcnZpY2UtYWNjb3VudC40N2hMVUlQTUpDNFhtR3dUT2MySUI3VDJ0Z0RQSGFPQ1U5cVE0aHdSVGJvPQ.H2RK8hJwd_SywyAtqWhpjSWJ1dI2L6cRU6rz7hfbD1s"
}
```
...
|demo-service-account       |demo-service-account                     |9 minutes ago |default |sB0jM2ZVtShYb0eg |drink="water" |
...
```bash Command
cpln serviceaccount remove-key demo-service-account --key skpyFpgryWFZzurY --org demo-cpln-organization
```
