...
```text Output
{
  ...
  "created": "2026-02-14T02:47:57.063Z",
  "key": "s0h3vXSeH3igEkMY.ZGVtby1jcGxuLW9yZ2FuaXphdGlvbi5kZW1vLXNlcnZpY2UtYWNjb3VudC5iVFkyUDZOaHc4OEFoZDN1akNrZkVydC9NaW1sK0ZBMkRsQ0I2TW9DRzFRPQ.SoyEcjW24sPvtW2qQC7pEmVV9LZhA_uRNjaLSnDRpD4"
}
```
...
|demo-service-account       |demo-service-account                     |9 minutes ago |default |s0h3vXSeH3igEkMY |drink="water" |
...
```bash Command
cpln serviceaccount remove-key demo-service-account --key sULAhe61BWzJ0vKw --org demo-cpln-organization
```
