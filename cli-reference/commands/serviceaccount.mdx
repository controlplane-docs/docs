...
```text Output
{
  ...
  "created": "2026-07-20T09:05:37.596Z",
  "key": "sl5az5Lmf9sljGNI.ZGVtby1jcGxuLW9yZ2FuaXphdGlvbi5kZW1vLXNlcnZpY2UtYWNjb3VudC4wRU9XVXFzM0xoQlFZYUZPeUMvbnJia3ZYeHBEWDVNNXBmdllkQmNqN2VJPQ.xeE9qWYlZbwC6sUxEw8CyfZfHjI1hPXv20T_YHAzid4"
}
```
...
|demo-service-account       |demo-service-account                     |9 minutes ago |default |sl5az5Lmf9sljGNI |drink="water" |
...
|NAME                 |DESCRIPTION          |CREATED        |ORIGIN  |KEYS             |TAGS          |
|---------------------|---------------------|---------------|--------|-----------------|--------------|
|demo-service-account |demo-service-account |10 minutes ago |default |sl5az5Lmf9sljGNI |drink="water" |
+---------------------+---------------------+---------------+--------+-----------------+--------------+
```
...
```bash Command
cpln serviceaccount remove-key demo-service-account --key s7YVhPZKHAXD4zuk --org demo-cpln-organization
```
