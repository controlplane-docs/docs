...
```text Output
{
  ...
  "created": "2026-07-27T15:05:05.206Z",
  "key": "sIAUCJtJL7E8Czi0.ZGVtby1jcGxuLW9yZ2FuaXphdGlvbi5kZW1vLXNlcnZpY2UtYWNjb3VudC5nRVZyN0NhZFNCVDdWWDZaVFY1ZnNZd3dpVStiRXNsQUJ4QzZ1dVBOWjVVPQ.q1mHPFDBlKlpjHf20hH2XNioGoiFIoxMjHDew08OfL8"
}
```
...
|demo-service-account       |demo-service-account                     |9 minutes ago |default |sIAUCJtJL7E8Czi0 |drink="water" |
...
|NAME                 |DESCRIPTION          |CREATED        |ORIGIN  |KEYS             |TAGS          |
|---------------------|---------------------|---------------|--------|-----------------|--------------|
|demo-service-account |demo-service-account |10 minutes ago |default |sIAUCJtJL7E8Czi0 |drink="water" |
+---------------------+---------------------+---------------+--------+-----------------+--------------+
```
...
```bash Command
cpln serviceaccount remove-key demo-service-account --key swpgzZutaLPidBfQ --org demo-cpln-organization
```
