...
```text Output
{
  ...
  "created": "2026-05-06T21:52:12.462Z",
  "key": "sCTyEBLzJr0zuRDU.ZGVtby1jcGxuLW9yZ2FuaXphdGlvbi5kZW1vLXNlcnZpY2UtYWNjb3VudC42aEcwVGJycFd0WWI1V0V0WnJteDBpUWJrSk5NdkZwN3VSaStpQTJYRzJBPQ.2seNJC2cHnf1MnrpNfN5wdIsAbEy0X8HCvDnakDSnNk"
}
```
...
|demo-service-account       |demo-service-account                     |7 minutes ago |default |sCTyEBLzJr0zuRDU |drink="water" |
...
```bash Command
cpln serviceaccount remove-key demo-service-account --key sylZ8CHzoEqwW6ZA --org demo-cpln-organization
```
