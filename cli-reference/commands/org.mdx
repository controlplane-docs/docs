---
title: org
description: "cpln org — Manage organizations, which are the top-level resource for grouping all other resources."
keywords: ['cpln org', 'organization', 'create org', 'org settings', 'org list', 'tenant', 'org members', 'org auth', 'top-level org', 'org billing']
---
...
```bash Command
cpln org create --name demo-cpln-organization --accountId ACCOUNT_ID --invitee EMAIL
```
...
```bash Command
cpln org tag demo-cpln-organization --remove-tag drink 
```
