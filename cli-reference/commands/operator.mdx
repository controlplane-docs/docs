---
title: operator
description: "cpln operator — Manage the Kubernetes operator that syncs Control Plane resources with a cluster."
keywords: ['cpln operator', 'kubernetes operator', 'k8s crd', 'argocd integration', 'gitops operator', 'control plane crd', 'cluster sync', 'operator install', 'k8s integration']
---
