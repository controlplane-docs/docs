---
title: task
description: "cpln task — Manage pending tasks that require approval or manual intervention."
keywords: ['cpln task', 'pending task', 'approval task', 'manual approval', 'task list', 'task complete', 'workflow task', 'task get', 'task review']
---
