---
title: group
description: "cpln group — Manage groups for organizing users and service accounts."
keywords: ['cpln group', 'rbac group', 'user group', 'group membership', 'service account group', 'iam group', 'team', 'access group', 'member query']
---
...
```bash Command
cpln group tag demo-group-tag-1 --remove-tag drink --org demo-cpln-organization
```
...
```bash Command
cpln group tag demo-group-tag-1 demo-group-tag-2 --remove-tag multiple-groups --org demo-cpln-organization
```
