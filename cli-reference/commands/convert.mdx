---
title: convert
description: "cpln convert — Convert Kubernetes resource files to Control Plane resource files."
keywords: ['cpln convert', 'kubectl to cpln', 'k8s to control plane', 'kubernetes manifest', 'helm convert', 'docker compose convert', 'manifest converter', 'migrate from k8s', 'convert yaml']
---
