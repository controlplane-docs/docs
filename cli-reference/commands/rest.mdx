---
title: rest
description: "cpln rest — Submit raw REST requests directly against the Control Plane API."
keywords: ['cpln rest', 'control plane api', 'raw api call', 'curl api', 'rest api', 'http request', 'cpln rest get', 'cpln rest post', 'api debugging']
---
