...
|------------|------------|---------------|------------|--------|--------|--------------|
|demo-policy |demo-policy |14 minutes ago |org         |all     |default |drink="water" |
+------------+------------+---------------+------------+--------+--------+--------------+
```
...
|NAME        |DESCRIPTION     |CREATED        |TARGET KIND |MATCHES |ORIGIN  |TAGS          |
|------------|----------------|---------------|------------|--------|--------|--------------|
|demo-policy |new description |15 minutes ago |org         |all     |default |drink="water" |
+------------+----------------+---------------+------------+--------+--------+--------------+
```
...
|NAME        |DESCRIPTION     |CREATED        |TARGET KIND |MATCHES |ORIGIN  |TAGS                  |
|------------|----------------|---------------|------------|--------|--------|----------------------|
|demo-policy |new description |15 minutes ago |org         |all     |default |demo-key="demo-value" |
|            |                |               |            |        |        |drink="water"         |
+------------+----------------+---------------+------------+--------+--------+----------------------+
```
