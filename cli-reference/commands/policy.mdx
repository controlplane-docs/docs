...
```bash Command
cpln policy tag demo-policy-tag-1 --remove-tag drink --org demo-cpln-organization
```
...
```bash Command
cpln policy tag demo-policy-tag-1 demo-policy-tag-2 --remove-tag multiple-policies --org demo-cpln-organization
```
