---
title: policy
description: "cpln policy — Manage access policies to resource that control permissions for users, groups, and service accounts."
keywords: ['cpln policy', 'access policy', 'rbac', 'iam policy', 'permission', 'policy create', 'allow rule', 'least privilege', 'role binding', 'authorization', 'target query']
---
...
|NAME        |DESCRIPTION     |CREATED       |TARGET KIND |MATCHES |ORIGIN  |TAGS          |
|------------|----------------|--------------|------------|--------|--------|--------------|
|demo-policy |new description |6 minutes ago |org         |all     |default |drink="water" |
+------------+----------------+--------------+------------+--------+--------+--------------+
```
...
|NAME        |DESCRIPTION     |CREATED       |TARGET KIND |MATCHES |ORIGIN  |TAGS                  |
|------------|----------------|--------------|------------|--------|--------|----------------------|
|demo-policy |new description |6 minutes ago |org         |all     |default |demo-key="demo-value" |
|            |                |              |            |        |        |drink="water"         |
+------------+----------------+--------------+------------+--------+--------+----------------------+
```
