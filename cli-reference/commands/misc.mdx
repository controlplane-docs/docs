---
title: misc
description: "cpln misc — Miscellaneous helper commands including shell completion and utility operations."
keywords: ['cpln misc', 'shell completion', 'bash completion', 'zsh completion', 'fish completion', 'cli helpers', 'cpln misc completion', 'cli utilities']
---
