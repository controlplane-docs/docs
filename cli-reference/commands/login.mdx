---
title: login
description: "cpln login — Create a default profile and launch a browser to authenticate with Control Plane."
keywords: ['cpln login', 'authenticate cli', 'browser login', 'sso login', 'saml login', 'profile setup', 'cpln auth', 'access token', 'device login']
---
