---
title: apply
description: "cpln apply — Create or update resources using an input file."
keywords: ['cpln apply', 'kubectl apply', 'declarative deploy', 'apply manifest', 'apply yaml', 'create or update', 'gitops apply', 'idempotent deploy', 'cpln apply --file', 'apply --ready']
---
