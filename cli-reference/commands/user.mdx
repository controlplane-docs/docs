---
title: user
description: "cpln user — Manage users and their access within your organization."
keywords: ['cpln user', 'user invite', 'add user', 'user list', 'remove user', 'manage users', 'org member', 'user permissions', 'user role']
---
...
|3mpcnkfyNhYXdjq8TbLefzXwyfu1 |Majid Abu Rmelah     |majid@controlplane.com |9 months ago |firebase |firebase/sign_in_provider="microsoft.com" |
...
```bash Command
cpln user tag test-128@example.com --remove-tag drink --org demo-cpln-organization
```
