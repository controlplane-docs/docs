---
title: logs
description: "cpln logs — Query and display logs from workloads and other Control Plane resources."
keywords: ['cpln logs', 'kubectl logs', 'workload logs', 'log query', 'logql', 'streaming logs', 'tail logs', 'log filter', 'log search', 'application logs']
---
