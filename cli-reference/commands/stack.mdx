---
title: stack
description: "cpln stack — Manage docker-compose files and deploy multi-service stacks to Control Plane."
keywords: ['cpln stack', 'docker compose deploy', 'compose up', 'multi-service deploy', 'compose stack', 'stack manifest', 'docker-compose alternative', 'multi-container', 'stack create']
---
