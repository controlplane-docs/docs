...
|---------|------------|--------------|--------------|-------|-----------------|--------------|
|demo-gvc |demo-gvc    |3 minutes ago |gc6x9917rk6et |       |aws-eu-central-1 |drink="water" |
|         |            |              |              |       |aws-us-west-2    |              |
+---------+------------+--------------+--------------+-------+-----------------+--------------+
```
...
|NAME           |DESCRIPTION       |CREATED |ALIAS         |DOMAIN |LOCATIONS        |TAGS          |
|---------------|------------------|--------|--------------|-------|-----------------|--------------|
|demo-gvc-clone |Clone of demo-gvc |Now     |gzavk6vxavys2 |       |aws-eu-central-1 |drink="water" |
|               |                  |        |              |       |aws-us-west-2    |              |
|               |                  |        |              |       |gcp-us-east1     |              |
+---------------+------------------+--------+--------------+-------+-----------------+--------------+
```
...
|NAME     |DESCRIPTION |CREATED |ALIAS         |DOMAIN |LOCATIONS        |TAGS          |
|---------|------------|--------|--------------|-------|-----------------|--------------|
|demo-gvc |demo-gvc    |Now     |gc6x9917rk6et |       |aws-eu-central-1 |drink="water" |
+---------+------------+--------+--------------+-------+-----------------+--------------+
```
...
|------------|------------|------------------------|------|--------|-----------------------------------------------------------|-----|
|workload-01 |workload-01 |demo-gvc-with-workloads |      |Now     |https://workload-01-m87ec44zhc7v0.geta3p46gfrsp.t.cpln.app |     |
|workload-02 |workload-02 |demo-gvc-with-workloads |      |Now     |https://workload-02-m87ec44zhc7v0.geta3p46gfrsp.t.cpln.app |     |
+------------+------------+------------------------+------+--------+-----------------------------------------------------------+-----+
```
...
|NAME                    |DESCRIPTION             |CREATED       |ALIAS         |DOMAIN |LOCATIONS        |TAGS          |
|------------------------|------------------------|--------------|--------------|-------|-----------------|--------------|
|demo-gvc                |demo-gvc                |4 minutes ago |gc6x9917rk6et |       |aws-eu-central-1 |drink="water" |
|                        |                        |              |              |       |aws-us-west-2    |              |
|                        |                        |              |              |       |gcp-us-east1     |              |
|demo-gvc-get-1          |demo-gvc-get-1          |Now           |vhnpeqw26qjvm |       |aws-eu-central-1 |              |
|demo-gvc-get-2          |demo-gvc-get-2          |Now           |gtqdcjrb3qsfm |       |aws-eu-central-1 |              |
|demo-gvc-identity       |demo-gvc-identity       |4 minutes ago |jbfs6w1dg4jk2 |       |aws-eu-central-1 |              |
|demo-gvc-with-workloads |demo-gvc-with-workloads |Now           |m87ec44zhc7v0 |       |aws-eu-central-1 |              |
|demo-gvc-workload       |demo-gvc-workload       |4 minutes ago |50bwe97nmfyhr |       |aws-eu-central-1 |              |
+------------------------+------------------------+--------------+--------------+-------+-----------------+--------------+
```
...
|NAME                    |DESCRIPTION             |CREATED |ALIAS         |DOMAIN |LOCATIONS        |TAGS |
|------------------------|------------------------|--------|--------------|-------|-----------------|-----|
|demo-gvc-with-locations |demo-gvc-with-locations |Now     |1a3d41vwbjp8y |       |aws-eu-central-1 |     |
|                        |                        |        |              |       |aws-us-west-2    |     |
|                        |                        |        |              |       |gcp-us-east1     |     |
+------------------------+------------------------+--------+--------------+-------+-----------------+-----+
```
...
|NAME                    |DESCRIPTION             |CREATED |ALIAS         |DOMAIN |LOCATIONS    |TAGS |
|------------------------|------------------------|--------|--------------|-------|-------------|-----|
|demo-gvc-with-locations |demo-gvc-with-locations |Now     |1a3d41vwbjp8y |       |gcp-us-east1 |     |
+------------------------+------------------------+--------+--------------+-------+-------------+-----+
```
...
|NAME           |DESCRIPTION    |CREATED |ALIAS         |DOMAIN |LOCATIONS        |TAGS          |
|---------------|---------------|--------|--------------|-------|-----------------|--------------|
|demo-gvc-tag-1 |demo-gvc-tag-1 |Now     |5221kmq6w88ym |       |aws-eu-central-1 |drink="water" |
+---------------+---------------+--------+--------------+-------+-----------------+--------------+
```
...
|NAME           |DESCRIPTION    |CREATED |ALIAS         |DOMAIN |LOCATIONS        |TAGS           |
|---------------|---------------|--------|--------------|-------|-----------------|---------------|
|demo-gvc-tag-1 |demo-gvc-tag-1 |Now     |5221kmq6w88ym |       |aws-eu-central-1 |drink="coffee" |
+---------------+---------------+--------+--------------+-------+-----------------+---------------+
```
...
|NAME           |DESCRIPTION    |CREATED |ALIAS         |DOMAIN |LOCATIONS        |TAGS |
|---------------|---------------|--------|--------------|-------|-----------------|-----|
|demo-gvc-tag-1 |demo-gvc-tag-1 |Now     |5221kmq6w88ym |       |aws-eu-central-1 |     |
+---------------+---------------+--------+--------------+-------+-----------------+-----+
```
...
|NAME           |DESCRIPTION    |CREATED |ALIAS         |DOMAIN |LOCATIONS        |TAGS                 |
|---------------|---------------|--------|--------------|-------|-----------------|---------------------|
|demo-gvc-tag-1 |demo-gvc-tag-1 |Now     |5221kmq6w88ym |       |aws-eu-central-1 |multiple-gvcs="true" |
|demo-gvc-tag-2 |demo-gvc-tag-2 |Now     |mh8ypha3fn1r6 |       |aws-eu-central-1 |multiple-gvcs="true" |
+---------------+---------------+--------+--------------+-------+-----------------+---------------------+
```
...
|NAME           |DESCRIPTION    |CREATED |ALIAS         |DOMAIN |LOCATIONS        |TAGS                     |
|---------------|---------------|--------|--------------|-------|-----------------|-------------------------|
|demo-gvc-tag-1 |demo-gvc-tag-1 |Now     |5221kmq6w88ym |       |aws-eu-central-1 |multiple-gvcs="demo-gvc" |
|demo-gvc-tag-2 |demo-gvc-tag-2 |Now     |mh8ypha3fn1r6 |       |aws-eu-central-1 |multiple-gvcs="demo-gvc" |
+---------------+---------------+--------+--------------+-------+-----------------+-------------------------+
```
...
|---------------|---------------|--------|--------------|-------|-----------------|-----|
|demo-gvc-tag-1 |demo-gvc-tag-1 |Now     |5221kmq6w88ym |       |aws-eu-central-1 |     |
|demo-gvc-tag-2 |demo-gvc-tag-2 |Now     |mh8ypha3fn1r6 |       |aws-eu-central-1 |     |
+---------------+---------------+--------+--------------+-------+-----------------+-----+
```
...
|NAME            |DESCRIPTION     |CREATED |ALIAS         |DOMAIN |LOCATIONS        |TAGS |
|----------------|----------------|--------|--------------|-------|-----------------|-----|
|demo-gvc-update |demo-gvc-update |Now     |82brzdvm0j4q0 |       |aws-eu-central-1 |     |
+----------------+----------------+--------+--------------+-------+-----------------+-----+
```
...
|NAME            |DESCRIPTION     |CREATED |ALIAS         |DOMAIN |LOCATIONS        |TAGS |
|----------------|----------------|--------|--------------|-------|-----------------|-----|
|demo-gvc-update |new description |Now     |82brzdvm0j4q0 |       |aws-eu-central-1 |     |
+----------------+----------------+--------+--------------+-------+-----------------+-----+
```
...
|NAME            |DESCRIPTION     |CREATED |ALIAS         |DOMAIN |LOCATIONS        |TAGS                  |
|----------------|----------------|--------|--------------|-------|-----------------|----------------------|
|demo-gvc-update |new description |Now     |82brzdvm0j4q0 |       |aws-eu-central-1 |demo-key="demo-value" |
+----------------+----------------+--------+--------------+-------+-----------------+----------------------+
```
