...
|---------|------------|--------------|--------------|----------|-----------------|--------------|
|demo-gvc |demo-gvc    |7 minutes ago |d2dv0bkarmdga |          |aws-eu-central-1 |drink="water" |
|         |            |              |              |          |aws-us-west-2    |              |
+---------+------------+--------------+--------------+----------+-----------------+--------------+
```
...
|NAME           |DESCRIPTION       |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS          |
|---------------|------------------|--------------|--------------|----------|-----------------|--------------|
|demo-gvc-clone |Clone of demo-gvc |0 minutes ago |p7yem2f4g0dnm |          |aws-eu-central-1 |drink="water" |
|               |                  |              |              |          |aws-us-west-2    |              |
|               |                  |              |              |          |gcp-us-east1     |              |
+---------------+------------------+--------------+--------------+----------+-----------------+--------------+
```
...
|NAME     |DESCRIPTION |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS          |
|---------|------------|--------------|--------------|----------|-----------------|--------------|
|demo-gvc |demo-gvc    |0 minutes ago |d2dv0bkarmdga |          |aws-eu-central-1 |drink="water" |
+---------+------------+--------------+--------------+----------+-----------------+--------------+
```
...
|------------|------------|------------------------|----------|--------------|-----------------------------------------------------------|-----|
|workload-02 |workload-02 |demo-gvc-with-workloads |          |0 minutes ago |https://workload-02-tx51mnth82wmy.geta3p46gfrsp.t.cpln.app |     |
|workload-01 |workload-01 |demo-gvc-with-workloads |          |0 minutes ago |https://workload-01-tx51mnth82wmy.geta3p46gfrsp.t.cpln.app |     |
+------------+------------+------------------------+----------+--------------+-----------------------------------------------------------+-----+
```
...
|NAME                    |DESCRIPTION             |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS          |
|------------------------|------------------------|--------------|--------------|----------|-----------------|--------------|
|demo-gvc                |demo-gvc                |8 minutes ago |d2dv0bkarmdga |          |aws-eu-central-1 |drink="water" |
|                        |                        |              |              |          |aws-us-west-2    |              |
|                        |                        |              |              |          |gcp-us-east1     |              |
|demo-gvc-get-1          |demo-gvc-get-1          |0 minutes ago |j4qwptrpxmj8r |          |aws-eu-central-1 |              |
|demo-gvc-get-2          |demo-gvc-get-2          |0 minutes ago |2y6nrbd87edbw |          |aws-eu-central-1 |              |
|demo-gvc-identity       |demo-gvc-identity       |8 minutes ago |e4hvkmb7eqbfa |          |aws-eu-central-1 |              |
|demo-gvc-with-workloads |demo-gvc-with-workloads |0 minutes ago |tx51mnth82wmy |          |aws-eu-central-1 |              |
|demo-gvc-workload       |demo-gvc-workload       |8 minutes ago |t8dskh9n228a8 |          |aws-eu-central-1 |              |
+------------------------+------------------------+--------------+--------------+----------+-----------------+--------------+
```
...
|NAME                    |DESCRIPTION             |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS |
|------------------------|------------------------|--------------|--------------|----------|-----------------|-----|
|demo-gvc-with-locations |demo-gvc-with-locations |0 minutes ago |p0djv3n2kp8s8 |          |aws-eu-central-1 |     |
|                        |                        |              |              |          |aws-us-west-2    |     |
|                        |                        |              |              |          |gcp-us-east1     |     |
+------------------------+------------------------+--------------+--------------+----------+-----------------+-----+
```
...
|NAME                    |DESCRIPTION             |CREATED       |ALIAS         |DOMAIN    |LOCATIONS    |TAGS |
|------------------------|------------------------|--------------|--------------|----------|-------------|-----|
|demo-gvc-with-locations |demo-gvc-with-locations |0 minutes ago |p0djv3n2kp8s8 |          |gcp-us-east1 |     |
+------------------------+------------------------+--------------+--------------+----------+-------------+-----+
```
...
|NAME           |DESCRIPTION    |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS          |
|---------------|---------------|--------------|--------------|----------|-----------------|--------------|
|demo-gvc-tag-1 |demo-gvc-tag-1 |0 minutes ago |7qzhe592a5rvj |          |aws-eu-central-1 |drink="water" |
+---------------+---------------+--------------+--------------+----------+-----------------+--------------+
```
...
|NAME           |DESCRIPTION    |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS           |
|---------------|---------------|--------------|--------------|----------|-----------------|---------------|
|demo-gvc-tag-1 |demo-gvc-tag-1 |0 minutes ago |7qzhe592a5rvj |          |aws-eu-central-1 |drink="coffee" |
+---------------+---------------+--------------+--------------+----------+-----------------+---------------+
```
...
|NAME           |DESCRIPTION    |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS |
|---------------|---------------|--------------|--------------|----------|-----------------|-----|
|demo-gvc-tag-1 |demo-gvc-tag-1 |0 minutes ago |7qzhe592a5rvj |          |aws-eu-central-1 |     |
+---------------+---------------+--------------+--------------+----------+-----------------+-----+
```
...
|NAME           |DESCRIPTION    |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS                 |
|---------------|---------------|--------------|--------------|----------|-----------------|---------------------|
|demo-gvc-tag-1 |demo-gvc-tag-1 |0 minutes ago |7qzhe592a5rvj |          |aws-eu-central-1 |multiple-gvcs="true" |
|demo-gvc-tag-2 |demo-gvc-tag-2 |0 minutes ago |14dsbcmqgqwwm |          |aws-eu-central-1 |multiple-gvcs="true" |
+---------------+---------------+--------------+--------------+----------+-----------------+---------------------+
```
...
|NAME           |DESCRIPTION    |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS                     |
|---------------|---------------|--------------|--------------|----------|-----------------|-------------------------|
|demo-gvc-tag-1 |demo-gvc-tag-1 |0 minutes ago |7qzhe592a5rvj |          |aws-eu-central-1 |multiple-gvcs="demo-gvc" |
|demo-gvc-tag-2 |demo-gvc-tag-2 |0 minutes ago |14dsbcmqgqwwm |          |aws-eu-central-1 |multiple-gvcs="demo-gvc" |
+---------------+---------------+--------------+--------------+----------+-----------------+-------------------------+
```
...
|---------------|---------------|--------------|--------------|----------|-----------------|-----|
|demo-gvc-tag-1 |demo-gvc-tag-1 |0 minutes ago |7qzhe592a5rvj |          |aws-eu-central-1 |     |
|demo-gvc-tag-2 |demo-gvc-tag-2 |0 minutes ago |14dsbcmqgqwwm |          |aws-eu-central-1 |     |
+---------------+---------------+--------------+--------------+----------+-----------------+-----+
```
...
|NAME            |DESCRIPTION     |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS |
|----------------|----------------|--------------|--------------|----------|-----------------|-----|
|demo-gvc-update |new description |0 minutes ago |pcrdf9xhjatnp |          |aws-eu-central-1 |     |
+----------------+----------------+--------------+--------------+----------+-----------------+-----+
```
...
|NAME            |DESCRIPTION     |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS                  |
|----------------|----------------|--------------|--------------|----------|-----------------|----------------------|
|demo-gvc-update |new description |0 minutes ago |pcrdf9xhjatnp |          |aws-eu-central-1 |demo-key="demo-value" |
+----------------+----------------+--------------+--------------+----------+-----------------+----------------------+
```
