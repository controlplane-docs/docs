...
|---------|------------|--------------|--------------|-------|-----------------|--------------|
|demo-gvc |demo-gvc    |3 minutes ago |5nvpwdzcnwnca |       |aws-eu-central-1 |drink="water" |
|         |            |              |              |       |aws-us-west-2    |              |
+---------+------------+--------------+--------------+-------+-----------------+--------------+
```
...
|NAME           |DESCRIPTION       |CREATED |ALIAS         |DOMAIN |LOCATIONS        |TAGS          |
|---------------|------------------|--------|--------------|-------|-----------------|--------------|
|demo-gvc-clone |Clone of demo-gvc |Now     |5trseeb1v2s4t |       |aws-eu-central-1 |drink="water" |
|               |                  |        |              |       |aws-us-west-2    |              |
|               |                  |        |              |       |gcp-us-east1     |              |
+---------------+------------------+--------+--------------+-------+-----------------+--------------+
```
...
|NAME     |DESCRIPTION |CREATED |ALIAS         |DOMAIN |LOCATIONS        |TAGS          |
|---------|------------|--------|--------------|-------|-----------------|--------------|
|demo-gvc |demo-gvc    |Now     |5nvpwdzcnwnca |       |aws-eu-central-1 |drink="water" |
+---------+------------+--------+--------------+-------+-----------------+--------------+
```
...
|------------|------------|------------------------|------|--------|-----------------------------------------------------------|-----|
|workload-02 |workload-02 |demo-gvc-with-workloads |      |Now     |https://workload-02-6hyc7f5mf2ecc.geta3p46gfrsp.t.cpln.app |     |
|workload-01 |workload-01 |demo-gvc-with-workloads |      |Now     |https://workload-01-6hyc7f5mf2ecc.geta3p46gfrsp.t.cpln.app |     |
+------------+------------+------------------------+------+--------+-----------------------------------------------------------+-----+
```
...
|NAME                    |DESCRIPTION             |CREATED       |ALIAS         |DOMAIN |LOCATIONS        |TAGS          |
|------------------------|------------------------|--------------|--------------|-------|-----------------|--------------|
|demo-gvc                |demo-gvc                |4 minutes ago |5nvpwdzcnwnca |       |aws-eu-central-1 |drink="water" |
|                        |                        |              |              |       |aws-us-west-2    |              |
|                        |                        |              |              |       |gcp-us-east1     |              |
|demo-gvc-get-1          |demo-gvc-get-1          |Now           |vzz2kmtqq19yw |       |aws-eu-central-1 |              |
|demo-gvc-get-2          |demo-gvc-get-2          |Now           |727wmvvf61m0j |       |aws-eu-central-1 |              |
|demo-gvc-identity       |demo-gvc-identity       |4 minutes ago |m04x9840s9ge8 |       |aws-eu-central-1 |              |
|demo-gvc-with-workloads |demo-gvc-with-workloads |Now           |6hyc7f5mf2ecc |       |aws-eu-central-1 |              |
|demo-gvc-workload       |demo-gvc-workload       |4 minutes ago |1gbs45pf0cpnp |       |aws-eu-central-1 |              |
+------------------------+------------------------+--------------+--------------+-------+-----------------+--------------+
```
...
|NAME                    |DESCRIPTION             |CREATED |ALIAS         |DOMAIN |LOCATIONS        |TAGS |
|------------------------|------------------------|--------|--------------|-------|-----------------|-----|
|demo-gvc-with-locations |demo-gvc-with-locations |Now     |8e1fym8barp80 |       |aws-eu-central-1 |     |
|                        |                        |        |              |       |aws-us-west-2    |     |
|                        |                        |        |              |       |gcp-us-east1     |     |
+------------------------+------------------------+--------+--------------+-------+-----------------+-----+
```
...
|NAME                    |DESCRIPTION             |CREATED |ALIAS         |DOMAIN |LOCATIONS    |TAGS |
|------------------------|------------------------|--------|--------------|-------|-------------|-----|
|demo-gvc-with-locations |demo-gvc-with-locations |Now     |8e1fym8barp80 |       |gcp-us-east1 |     |
+------------------------+------------------------+--------+--------------+-------+-------------+-----+
```
...
|NAME           |DESCRIPTION    |CREATED |ALIAS         |DOMAIN |LOCATIONS        |TAGS          |
|---------------|---------------|--------|--------------|-------|-----------------|--------------|
|demo-gvc-tag-1 |demo-gvc-tag-1 |Now     |4san56j8fxmgj |       |aws-eu-central-1 |drink="water" |
+---------------+---------------+--------+--------------+-------+-----------------+--------------+
```
...
|NAME           |DESCRIPTION    |CREATED |ALIAS         |DOMAIN |LOCATIONS        |TAGS           |
|---------------|---------------|--------|--------------|-------|-----------------|---------------|
|demo-gvc-tag-1 |demo-gvc-tag-1 |Now     |4san56j8fxmgj |       |aws-eu-central-1 |drink="coffee" |
+---------------+---------------+--------+--------------+-------+-----------------+---------------+
```
...
|NAME           |DESCRIPTION    |CREATED |ALIAS         |DOMAIN |LOCATIONS        |TAGS |
|---------------|---------------|--------|--------------|-------|-----------------|-----|
|demo-gvc-tag-1 |demo-gvc-tag-1 |Now     |4san56j8fxmgj |       |aws-eu-central-1 |     |
+---------------+---------------+--------+--------------+-------+-----------------+-----+
```
...
|NAME           |DESCRIPTION    |CREATED |ALIAS         |DOMAIN |LOCATIONS        |TAGS                 |
|---------------|---------------|--------|--------------|-------|-----------------|---------------------|
|demo-gvc-tag-1 |demo-gvc-tag-1 |Now     |4san56j8fxmgj |       |aws-eu-central-1 |multiple-gvcs="true" |
|demo-gvc-tag-2 |demo-gvc-tag-2 |Now     |nz7egds5gr2qc |       |aws-eu-central-1 |multiple-gvcs="true" |
+---------------+---------------+--------+--------------+-------+-----------------+---------------------+
```
...
|NAME           |DESCRIPTION    |CREATED |ALIAS         |DOMAIN |LOCATIONS        |TAGS                     |
|---------------|---------------|--------|--------------|-------|-----------------|-------------------------|
|demo-gvc-tag-1 |demo-gvc-tag-1 |Now     |4san56j8fxmgj |       |aws-eu-central-1 |multiple-gvcs="demo-gvc" |
|demo-gvc-tag-2 |demo-gvc-tag-2 |Now     |nz7egds5gr2qc |       |aws-eu-central-1 |multiple-gvcs="demo-gvc" |
+---------------+---------------+--------+--------------+-------+-----------------+-------------------------+
```
...
|---------------|---------------|--------|--------------|-------|-----------------|-----|
|demo-gvc-tag-1 |demo-gvc-tag-1 |Now     |4san56j8fxmgj |       |aws-eu-central-1 |     |
|demo-gvc-tag-2 |demo-gvc-tag-2 |Now     |nz7egds5gr2qc |       |aws-eu-central-1 |     |
+---------------+---------------+--------+--------------+-------+-----------------+-----+
```
...
|NAME            |DESCRIPTION     |CREATED |ALIAS         |DOMAIN |LOCATIONS        |TAGS |
|----------------|----------------|--------|--------------|-------|-----------------|-----|
|demo-gvc-update |demo-gvc-update |Now     |ff2086rdrfvc6 |       |aws-eu-central-1 |     |
+----------------+----------------+--------+--------------+-------+-----------------+-----+
```
...
|NAME            |DESCRIPTION     |CREATED |ALIAS         |DOMAIN |LOCATIONS        |TAGS |
|----------------|----------------|--------|--------------|-------|-----------------|-----|
|demo-gvc-update |new description |Now     |ff2086rdrfvc6 |       |aws-eu-central-1 |     |
+----------------+----------------+--------+--------------+-------+-----------------+-----+
```
...
|NAME            |DESCRIPTION     |CREATED |ALIAS         |DOMAIN |LOCATIONS        |TAGS                  |
|----------------|----------------|--------|--------------|-------|-----------------|----------------------|
|demo-gvc-update |new description |Now     |ff2086rdrfvc6 |       |aws-eu-central-1 |demo-key="demo-value" |
+----------------+----------------+--------+--------------+-------+-----------------+----------------------+
```
