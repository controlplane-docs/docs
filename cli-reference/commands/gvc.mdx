...
|---------|------------|--------------|--------------|-------|-----------------|--------------|
|demo-gvc |demo-gvc    |3 minutes ago |mr96bde0hhmbw |       |aws-eu-central-1 |drink="water" |
|         |            |              |              |       |aws-us-west-2    |              |
+---------+------------+--------------+--------------+-------+-----------------+--------------+
```
...
|NAME     |DESCRIPTION |CREATED       |ALIAS         |DOMAIN |LOCATIONS        |TAGS          |
|---------|------------|--------------|--------------|-------|-----------------|--------------|
|demo-gvc |demo-gvc    |4 minutes ago |mr96bde0hhmbw |       |aws-eu-central-1 |drink="water" |
|         |            |              |              |       |aws-us-west-2    |              |
|         |            |              |              |       |gcp-us-east1     |              |
+---------+------------+--------------+--------------+-------+-----------------+--------------+
```
...
|NAME           |DESCRIPTION       |CREATED |ALIAS         |DOMAIN |LOCATIONS        |TAGS          |
|---------------|------------------|--------|--------------|-------|-----------------|--------------|
|demo-gvc-clone |Clone of demo-gvc |Now     |h59rx0zz21cat |       |aws-eu-central-1 |drink="water" |
|               |                  |        |              |       |aws-us-west-2    |              |
|               |                  |        |              |       |gcp-us-east1     |              |
+---------------+------------------+--------+--------------+-------+-----------------+--------------+
```
...
|NAME     |DESCRIPTION |CREATED |ALIAS         |DOMAIN |LOCATIONS        |TAGS          |
|---------|------------|--------|--------------|-------|-----------------|--------------|
|demo-gvc |demo-gvc    |Now     |mr96bde0hhmbw |       |aws-eu-central-1 |drink="water" |
+---------+------------+--------+--------------+-------+-----------------+--------------+
```
...
|------------|------------|------------------------|------|--------|-----------------------------------------------------------|-----|
|workload-01 |workload-01 |demo-gvc-with-workloads |      |Now     |https://workload-01-k59m2gv312404.geta3p46gfrsp.t.cpln.app |     |
|workload-02 |workload-02 |demo-gvc-with-workloads |      |Now     |https://workload-02-k59m2gv312404.geta3p46gfrsp.t.cpln.app |     |
+------------+------------+------------------------+------+--------+-----------------------------------------------------------+-----+
```
...
|                        |                        |              |              |       |aws-us-west-2    |              |
|                        |                        |              |              |       |gcp-us-east1     |              |
|demo-gvc-get-1          |demo-gvc-get-1          |Now           |1jqz4t0qx59ze |       |aws-eu-central-1 |              |
|demo-gvc-get-2          |demo-gvc-get-2          |Now           |p8y01149cyt5j |       |aws-eu-central-1 |              |
|demo-gvc-identity       |demo-gvc-identity       |4 minutes ago |hn9vjj1s3ksja |       |aws-eu-central-1 |              |
|demo-gvc-with-workloads |demo-gvc-with-workloads |Now           |k59m2gv312404 |       |aws-eu-central-1 |              |
|demo-gvc-workload       |demo-gvc-workload       |4 minutes ago |mtp8x545pzxsc |       |aws-eu-central-1 |              |
+------------------------+------------------------+--------------+--------------+-------+-----------------+--------------+
```
...
|NAME                    |DESCRIPTION             |CREATED |ALIAS         |DOMAIN |LOCATIONS        |TAGS |
|------------------------|------------------------|--------|--------------|-------|-----------------|-----|
|demo-gvc-with-locations |demo-gvc-with-locations |Now     |rhfksp3vmjfha |       |aws-eu-central-1 |     |
|                        |                        |        |              |       |aws-us-west-2    |     |
|                        |                        |        |              |       |gcp-us-east1     |     |
+------------------------+------------------------+--------+--------------+-------+-----------------+-----+
```
...
|NAME                    |DESCRIPTION             |CREATED |ALIAS         |DOMAIN |LOCATIONS    |TAGS |
|------------------------|------------------------|--------|--------------|-------|-------------|-----|
|demo-gvc-with-locations |demo-gvc-with-locations |Now     |rhfksp3vmjfha |       |gcp-us-east1 |     |
+------------------------+------------------------+--------+--------------+-------+-------------+-----+
```
...
|NAME           |DESCRIPTION    |CREATED |ALIAS         |DOMAIN |LOCATIONS        |TAGS          |
|---------------|---------------|--------|--------------|-------|-----------------|--------------|
|demo-gvc-tag-1 |demo-gvc-tag-1 |Now     |7rk7yq3pmfj0c |       |aws-eu-central-1 |drink="water" |
+---------------+---------------+--------+--------------+-------+-----------------+--------------+
```
...
|NAME           |DESCRIPTION    |CREATED |ALIAS         |DOMAIN |LOCATIONS        |TAGS           |
|---------------|---------------|--------|--------------|-------|-----------------|---------------|
|demo-gvc-tag-1 |demo-gvc-tag-1 |Now     |7rk7yq3pmfj0c |       |aws-eu-central-1 |drink="coffee" |
+---------------+---------------+--------+--------------+-------+-----------------+---------------+
```
...
|NAME           |DESCRIPTION    |CREATED |ALIAS         |DOMAIN |LOCATIONS        |TAGS |
|---------------|---------------|--------|--------------|-------|-----------------|-----|
|demo-gvc-tag-1 |demo-gvc-tag-1 |Now     |7rk7yq3pmfj0c |       |aws-eu-central-1 |     |
+---------------+---------------+--------+--------------+-------+-----------------+-----+
```
...
|NAME           |DESCRIPTION    |CREATED |ALIAS         |DOMAIN |LOCATIONS        |TAGS                 |
|---------------|---------------|--------|--------------|-------|-----------------|---------------------|
|demo-gvc-tag-1 |demo-gvc-tag-1 |Now     |7rk7yq3pmfj0c |       |aws-eu-central-1 |multiple-gvcs="true" |
|demo-gvc-tag-2 |demo-gvc-tag-2 |Now     |5hvjha8cneprm |       |aws-eu-central-1 |multiple-gvcs="true" |
+---------------+---------------+--------+--------------+-------+-----------------+---------------------+
```
...
|NAME           |DESCRIPTION    |CREATED |ALIAS         |DOMAIN |LOCATIONS        |TAGS                     |
|---------------|---------------|--------|--------------|-------|-----------------|-------------------------|
|demo-gvc-tag-1 |demo-gvc-tag-1 |Now     |7rk7yq3pmfj0c |       |aws-eu-central-1 |multiple-gvcs="demo-gvc" |
|demo-gvc-tag-2 |demo-gvc-tag-2 |Now     |5hvjha8cneprm |       |aws-eu-central-1 |multiple-gvcs="demo-gvc" |
+---------------+---------------+--------+--------------+-------+-----------------+-------------------------+
```
...
|---------------|---------------|--------|--------------|-------|-----------------|-----|
|demo-gvc-tag-1 |demo-gvc-tag-1 |Now     |7rk7yq3pmfj0c |       |aws-eu-central-1 |     |
|demo-gvc-tag-2 |demo-gvc-tag-2 |Now     |5hvjha8cneprm |       |aws-eu-central-1 |     |
+---------------+---------------+--------+--------------+-------+-----------------+-----+
```
...
|NAME            |DESCRIPTION     |CREATED |ALIAS         |DOMAIN |LOCATIONS        |TAGS |
|----------------|----------------|--------|--------------|-------|-----------------|-----|
|demo-gvc-update |demo-gvc-update |Now     |9130n5sj84vjj |       |aws-eu-central-1 |     |
+----------------+----------------+--------+--------------+-------+-----------------+-----+
```
...
|NAME            |DESCRIPTION     |CREATED |ALIAS         |DOMAIN |LOCATIONS        |TAGS |
|----------------|----------------|--------|--------------|-------|-----------------|-----|
|demo-gvc-update |new description |Now     |9130n5sj84vjj |       |aws-eu-central-1 |     |
+----------------+----------------+--------+--------------+-------+-----------------+-----+
```
...
|NAME            |DESCRIPTION     |CREATED |ALIAS         |DOMAIN |LOCATIONS        |TAGS                  |
|----------------|----------------|--------|--------------|-------|-----------------|----------------------|
|demo-gvc-update |new description |Now     |9130n5sj84vjj |       |aws-eu-central-1 |demo-key="demo-value" |
+----------------+----------------+--------+--------------+-------+-----------------+----------------------+
```
