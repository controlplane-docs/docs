---
title: mk8s
description: "cpln mk8s — Manage mk8s clusters for running managed Kubernetes on Control Plane."
keywords: ['cpln mk8s', 'managed kubernetes', 'k8s cluster', 'mk8s create', 'managed k8s', 'cluster provisioning', 'kubeconfig', 'eks alternative', 'gke alternative', 'aks alternative', 'byok k8s']
---
...
Commands:
  ...
  cpln mk8s health <ref>         Show the readiness status of an mk8s cluster
