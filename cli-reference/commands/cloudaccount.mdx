...
```bash Command
cpln cloudaccount tag demo-cloud-account-azure --remove-tag drink --org demo-cpln-organization
```
...
```bash Command
cpln cloudaccount tag demo-cloud-account-azure demo-cloud-account-gcp --remove-tag multiple-cloudaccounts --org demo-cpln-organization
```
