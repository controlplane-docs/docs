---
title: cloudaccount
description: "cpln cloudaccount — Manage cloud accounts that connect external cloud providers to Control Plane."
keywords: ['cpln cloudaccount', 'aws account', 'gcp account', 'azure account', 'ngs account', 'cloud provider link', 'cross-account', 'iam role', 'cloud connect', 'register cloud']
---
