---
title: volumeset
description: "cpln volumeset — Manage persistent volume sets within a GVC. Supports traditional filesystems (ext4, xfs) for stateful workloads and shared filesystems for any workload type."
keywords: ['cpln volumeset', 'persistent volume', 'pvc', 'stateful storage', 'volumeset create', 'shared filesystem', 'ext4 xfs', 'volume snapshot', 'block storage', 'shared storage']
---
