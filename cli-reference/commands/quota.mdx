...
|3859c1da-f9ee-4465-823a-d7035f17292b |identities-per-gvc    |Max number of workload identities in ... |builtin |4       |20   |count     |gvcLink="demo-gvc-identity"       |
...
|8a871190-7026-40c6-8089-e16739e61123 |workloads-per-gvc     |Max number of workloads in a gvc         |builtin |1       |20   |count     |gvcLink="demo-gvc-workload"       |
...
|f4126cb5-5faf-4a48-957c-399d95003733 |workloads-per-gvc     |Max number of workloads in a gvc         |builtin |0       |20   |count     |gvcLink="demo-gvc-with-workloads" |
+-------------------------------------+----------------------+-----------------------------------------+--------+--------+-----+----------+----------------------------------+
```
