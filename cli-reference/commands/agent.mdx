---
title: agent
description: "cpln agent — Manage agents that connect self-hosted infrastructure to Control Plane."
keywords: ['cpln agent', 'wormhole agent', 'self-hosted agent', 'private network access', 'on-prem connectivity', 'tunnel agent', 'agent token', 'agent bootstrap', 'cross-cloud connectivity', 'vpc access']
---
...
```text Output
{
  "agentId": "fcd4857d-b1cd-4c8a-a0ec-fd4a6c825b90",
  "agentLink": "/org/demo-cpln-organization/agent/demo-agent",
  "hubEndpoint": "https://hub.test.cpln.io",
  "registrationToken": "a2BRuTKERhu99K7ilN63vmD-0Q_C3qAgOlNcUDyQtp_CoDPao03EBTww/h6y594",
  "protocolVersion": "v2"
}
```
...
```bash Command
cpln agent tag demo-agent --remove-tag drink --org demo-cpln-organization
```
