---
title: ipset
description: "cpln ipset — Reserve and manage static public IP addresses for workloads and GVC load balancers."
keywords: ['cpln ipset', 'static ip', 'ip whitelist', 'reserved ip', 'load balancer ip', 'egress ip', 'fixed ip', 'ipset create', 'ip allocation']
---
