---
title: port-forward
description: "cpln port-forward — Establish secure local port forwarding to a running workload."
keywords: ['cpln port-forward', 'kubectl port-forward', 'localhost tunnel', 'db tunnel', 'tcp forward', 'local proxy', 'remote port', 'replica access', 'debug port', 'private endpoint local']
---
