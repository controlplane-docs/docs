---
title: domain
description: "cpln domain — Manage custom domains for routing traffic to your workloads."
keywords: ['cpln domain', 'custom domain', 'cname', 'ns delegation', 'tls certificate', 'domain create', 'subdomain', 'route53 alternative', 'domain manifest', 'domain routing']
---
...
```bash Command
cpln domain tag demo.globalvirtualcloud.com --remove-tag name --org demo-cpln-organization
```
...
```bash Command
cpln domain tag demo.globalvirtualcloud.com demo2.globalvirtualcloud.com --remove-tag multiple-domains --org demo-cpln-organization
```
