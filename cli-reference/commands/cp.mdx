---
title: cp
description: "cpln cp — Copy files and directories to and from running workloads."
keywords: ['cpln cp', 'kubectl cp', 'docker cp', 'scp', 'sync files', 'upload to workload', 'download from workload', 'file transfer', 'rsync', 'put file', 'get file']
---
