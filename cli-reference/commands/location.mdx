---
title: location
description: "cpln location — Manage cloud provider regions and custom BYOK locations available for workload deployment."
keywords: ['cpln location', 'gcp region', 'aws region', 'azure region', 'byok location', 'edge location', 'cloud region', 'multi-region deploy', 'location list']
---
...
```bash Command
cpln location tag aws-eu-central-1 --remove-tag drink --org demo-cpln-organization
```
...
```bash Command
cpln location tag aws-eu-central-1 azure-eastus2 --remove-tag multiple-locations --org demo-cpln-organization
```
