...
<Tip>
Working with an AI assistant? The [Control Plane AI Plugin](/ai/plugin) teaches Claude Code, Codex, and Gemini CLI how to drive `cpln` correctly — including the resource command map, hallucination traps, and the multi-step workflows that the CLI doesn't bundle into single commands.
</Tip>
