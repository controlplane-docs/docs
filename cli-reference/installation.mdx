...
<Step title="Download the binary">
  <Tabs>
    <Tab title="Browser">
      <CardGroup cols={2}>
        <Card title="macOS (ARM64)" icon="apple" href="https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/2505100923-6cd84ed9/cpln-macos-arm64.dmg">
          Download for Apple Silicon
        </Card>
        <Card title="macOS (x64)" icon="apple" href="https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/2505100923-6cd84ed9/cpln-macos-x64.dmg">
          Download for Intel Macs
        </Card>
        <Card title="Linux / WSL2" icon="linux" href="https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/2505100923-6cd84ed9/cpln-linux.tgz">
          Download for Linux (x64) or for Windows (WSL2)
        </Card>
        <Card title="Windows" icon="microsoft" href="https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/2505100923-6cd84ed9/cpln-win.zip">
    ...
    <Tab title="Command line">
      <Tabs>
        <Tab title="macOS (ARM64)" icon="apple">
          ```bash
          curl -LO https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/2505100923-6cd84ed9/cpln-macos-arm64.dmg
          ```
        </Tab>

        <Tab title="macOS (x64)" icon="apple">
          ```bash
          curl -LO https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/2505100923-6cd84ed9/cpln-macos-x64.dmg
          ```
        </Tab>
        ...
        <CodeGroup>
          ```bash curl
          curl -LO https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/2505100923-6cd84ed9/cpln-linux.tgz
          ```

          ```bash wget
          wget https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/2505100923-6cd84ed9/cpln-linux.tgz
          ```
        </CodeGroup>
        ...
        <Tab title="Windows (PowerShell)" icon="microsoft">
          ```powershell
          Invoke-WebRequest -Uri "https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/2505100923-6cd84ed9/cpln-win.zip" -OutFile "cpln-win.zip"
          ```
        </Tab>
...
| OS            | File                 | SHA256               |
|---------------|----------------------|----------------------|
| macOS-arm64   | cpln-macos-arm64.dmg | b1177a73ce110a701d5c7292ae3d3c51c23527eca809a67a6a2c8bf0ebe7f80d |
| macOS-x64     | cpln-macos-x64.dmg   | 13c3b8b17a7b7374189706602cecb6f16e1a204689a6bb05cd1664211aea7d0a |
| Linux         | cpln-linux.tgz       | 302abbcd605531ce3231890fdf5bb71d316581d3eb4060a05f19688a020436e5 |
| Windows 10/11 | cpln-win.zip         | 75f5d07133d26b4aa4e73580cb24b9eb28f8dba9e7de0043dfc0fc9c0b3701e5 |
</Accordion>
