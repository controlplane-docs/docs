...
keywords: ['npm install', 'homebrew', 'brew install', 'binary download', 'install on mac', 'install on linux', 'install on windows', 'apt', 'update cli', 'version check', 'cpln upgrade']
---
...
<Step title="Download the binary">
  <Tabs>
    <Tab title="Browser">
      <CardGroup cols={2}>
        <Card title="macOS (ARM64)" icon="apple" href="https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/2676685351-164899d4/cpln-macos-arm64.dmg">
          Download for Apple Silicon
        </Card>
        <Card title="macOS (x64)" icon="apple" href="https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/2676685351-164899d4/cpln-macos-x64.dmg">
          Download for Intel Macs
        </Card>
        <Card title="Linux / WSL2" icon="linux" href="https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/2676685351-164899d4/cpln-linux.tgz">
          Download for Linux (x64) or for Windows (WSL2)
        </Card>
        <Card title="Windows" icon="microsoft" href="https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/2676685351-164899d4/cpln-win.zip">
    ...
    <Tab title="Command line">
      <Tabs>
        <Tab title="macOS (ARM64)" icon="apple">
          ```bash
          curl -LO https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/2676685351-164899d4/cpln-macos-arm64.dmg
          ```
        </Tab>

        <Tab title="macOS (x64)" icon="apple">
          ```bash
          curl -LO https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/2676685351-164899d4/cpln-macos-x64.dmg
          ```
        </Tab>
        ...
        <CodeGroup>
          ```bash curl
          curl -LO https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/2676685351-164899d4/cpln-linux.tgz
          ```

          ```bash wget
          wget https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/2676685351-164899d4/cpln-linux.tgz
          ```
        </CodeGroup>
        ...
        <Tab title="Windows (PowerShell)" icon="microsoft">
          ```powershell
          Invoke-WebRequest -Uri "https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/2676685351-164899d4/cpln-win.zip" -OutFile "cpln-win.zip"
          ```
        </Tab>
...
<Step title="Extract and add to PATH">
  <Tabs>
    ...
    <Tab title="Windows (WSL2)" icon="linux">
      ...
      <Note>
      **Logging in from WSL2:** No browser is needed inside WSL2. `cpln login` prints a login URL and a confirmation code rather than opening a browser, so you can paste the URL into your Windows browser, sign in, and enter the code. The CLI running in WSL2 picks up the credentials on its own.
      </Note>
    </Tab>
  </Tabs>
</Step>
...
| OS            | File                 | SHA256               |
|---------------|----------------------|----------------------|
| macOS-arm64   | cpln-macos-arm64.dmg | 0643632b5e635383702d2a799c2947c9aadf04eb3b967cb57bfd9c043ea7fa94 |
| macOS-x64     | cpln-macos-x64.dmg   | 18068e85cc798beb8b4972bea081b12de19a62e3578d468585be734cc71c0997 |
| Linux         | cpln-linux.tgz       | 63a52d9ea6a1968ecd5ea419eec5e661d2fec12b594c7e8876169c7618e344ab |
| Windows 10/11 | cpln-win.zip         | 9c251846e7803dec1bf068e2dfc5f1a26ec895b5847a240310efd6d6b5cf6d88 |
</Accordion>
