...
<Step title="Download the binary">
  <Tabs>
    <Tab title="Browser">
      <CardGroup cols={2}>
        <Card title="macOS (ARM64)" icon="apple" href="https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/2388528711-a80e5a4d/cpln-macos-arm64.dmg">
          Download for Apple Silicon
        </Card>
        <Card title="macOS (x64)" icon="apple" href="https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/2388528711-a80e5a4d/cpln-macos-x64.dmg">
          Download for Intel Macs
        </Card>
        <Card title="Linux / WSL2" icon="linux" href="https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/2388528711-a80e5a4d/cpln-linux.tgz">
          Download for Linux (x64) or for Windows (WSL2)
        </Card>
        <Card title="Windows" icon="microsoft" href="https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/2388528711-a80e5a4d/cpln-win.zip">
    ...
    <Tab title="Command line">
      <Tabs>
        <Tab title="macOS (ARM64)" icon="apple">
          ```bash
          curl -LO https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/2388528711-a80e5a4d/cpln-macos-arm64.dmg
          ```
        </Tab>

        <Tab title="macOS (x64)" icon="apple">
          ```bash
          curl -LO https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/2388528711-a80e5a4d/cpln-macos-x64.dmg
          ```
        </Tab>
        ...
        <CodeGroup>
          ```bash curl
          curl -LO https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/2388528711-a80e5a4d/cpln-linux.tgz
          ```

          ```bash wget
          wget https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/2388528711-a80e5a4d/cpln-linux.tgz
          ```
        </CodeGroup>
        ...
        <Tab title="Windows (PowerShell)" icon="microsoft">
          ```powershell
          Invoke-WebRequest -Uri "https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/2388528711-a80e5a4d/cpln-win.zip" -OutFile "cpln-win.zip"
          ```
        </Tab>
...
| OS            | File                 | SHA256               |
|---------------|----------------------|----------------------|
| macOS-arm64   | cpln-macos-arm64.dmg | 78aa1df64e95077cb173991557bbc48620bab64a83d4c278892e3001d196c851 |
| macOS-x64     | cpln-macos-x64.dmg   | d03e4d050d53096c9771d6546f3a2524de8019e653adcd2b13a296fe96dc346e |
| Linux         | cpln-linux.tgz       | 904c30a2b14131c4a7b9796f1fc131d9da3dc478836cfaec0c604fb7b0ba9783 |
| Windows 10/11 | cpln-win.zip         | 5e92a7fdaf3cf093bd6a6a0166ebb152fef8a5fd21387b7f9dc271a00c4fe1aa |
</Accordion>
