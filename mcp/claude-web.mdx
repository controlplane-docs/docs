...
<Note>
  Connectors sync across Claude. Setting this up on claude.ai also enables it in the [Claude desktop app](/mcp/claude-desktop), and vice versa — you only need to do it once.
</Note>
