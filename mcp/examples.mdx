...
keywords: ['sample prompts', 'mcp prompts', 'cpln mcp', 'deploy prompt', 'troubleshoot prompt', 'set context', 'ai workflows', 'common tasks', 'prompt examples', 'demo']
---

This page provides practical examples of how to interact with Control Plane through AI assistants using the MCP Server. These examples work across all [compatible tools](/mcp/mcp-server#compatible-tools).
...
```text Grant Workload Access to a Secret
...
<CardGroup cols={2}>
  <Card title="Tool Setup" icon="gear" href="/mcp/mcp-server">
