---
title: 'Replica'
description: 'A pod in Kubernetes terms. Autoscaling decides how many run in each location, the readiness probe decides which ones receive traffic, and Control Plane replaces any that stop.'
