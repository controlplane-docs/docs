---
title: 'Location'
description: 'Built-in cloud regions and CPLN BYOK clusters under one contract: the org decides which are enabled, each GVC decides which it spans, and geography decides which answers a request.'
