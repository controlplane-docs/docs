---
title: 'Deployment'
description: 'One read-only status record per location, written by Control Plane: ready says whether that location serves, deploying says whether a rollout is still under way, and old and new versions stay listed side by side until the new one is ready.'
