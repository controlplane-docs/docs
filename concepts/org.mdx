...
description: 'The top-level isolation boundary, holding every GVC, workload, policy, secret, and user. Membership is granted per org, its policies decide who can do what inside it, and the account that pays for it decides nothing inside it.'
