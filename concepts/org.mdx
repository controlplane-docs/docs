...
description: 'Organizations are the top-level isolation boundary in Control Plane. Each contains all resources including GVCs, workloads, policies, secrets, and user access controls.'
