...
- Create an [identity](/reference/identity) and assign the desired [cloud access](/guides/create-resources/create-identity#cloud-access) to resources within each registered [cloud account](/reference/cloudaccount).
