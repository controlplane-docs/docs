...
description: "Two-part access control system combining billing account roles with org-level policies. Covers principals, permissions, and fine-grained authorization."
keywords: ['rbac', 'iam', 'least privilege', 'auth', 'identity management', 'binding', 'group', 'service account', 'authz', 'org_creator', 'billing_admin', 'billing_viewer']
---
