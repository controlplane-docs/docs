---
title: Logz.io
description: Configure log shipping from Control Plane to Logz.io for observability with AI-powered log analysis and real-time visualization.
keywords: ['log forwarding', 'log export', 'log sink', 'opaque secret', 'shipping token', 'listener url', 'siem', 'elk', 'managed elastic']
---
