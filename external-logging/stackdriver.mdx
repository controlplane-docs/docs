---
title: Stackdriver
description: Configure log shipping from Control Plane to Google Cloud Stackdriver (Operations Suite) for monitoring and log analysis.
keywords: ['gcp logging', 'cloud logging', 'log forwarding', 'log export', 'log sink', 'gcp credentials', 'service account key', 'gcp ops']
---
