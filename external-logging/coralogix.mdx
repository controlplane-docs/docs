...
7. This secret will be used when configuring logging using the [UI Console](#logging-ui) or [CLI](#logging-cli).
...
4. Select the Opaque secret created to authenticate to Coralogix. Refer to the [credential procurement](#credential-procurement) section to obtain and configure the necessary credentials.
5. Click `Save`.
