---
title: Coralogix
description: Configure log shipping from Control Plane to Coralogix for log management, analytics, and visualization.
keywords: ['log forwarding', 'log export', 'log sink', 'siem', 'opaque secret', 'api key', 'observability', 'log analytics platform']
---
