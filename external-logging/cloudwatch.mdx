---
title: CloudWatch
description: Configure log shipping from Control Plane to AWS CloudWatch for real-time monitoring and log analysis.
keywords: ['amazon', 'log forwarding', 'log group', 'log stream', 'cwl', 'aws metrics', 'log sink', 'log export', 'iam credentials', 'access key']
---
