---
title: 'Syslog'
description: 'Forward Control Plane org logs to a syslog server over TCP using the rfc3164 format, configured in the Console or with an org manifest.'
keywords: ['log shipping', 'log forwarding', 'external logs', 'rsyslog', 'syslog-ng', 'port 514', 'severity', 'centralized logging', 'log export', 'logging provider']
---
## Overview
