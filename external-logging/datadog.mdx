---
title: Datadog
description: Configure log shipping from Control Plane to Datadog for comprehensive log management, analytics, and visualization.
keywords: ['dd', 'apm', 'log forwarding', 'log export', 'log sink', 'observability', 'opaque secret', 'api key', 'datadoghq', 'site eu', 'site us']
---
