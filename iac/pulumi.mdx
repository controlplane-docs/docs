...
sidebarTitle: Pulumi
description: Manage Control Plane resources as infrastructure-as-code using the official Pulumi provider with JavaScript, Python, Go, or .NET.
keywords: ['iac', 'typescript', 'csharp', 'dotnet', 'pulumi cli', 'pulumi registry', 'cpln package', 'pulumi up', 'pulumi preview', 'install pulumi', 'gitops', 'state']
---
