...
description: Manage Control Plane resources as infrastructure-as-code using the official Terraform provider with HCL configuration.
keywords: ['iac', 'hashicorp', 'tf', 'tfstate', 'terraform plan', 'terraform apply', 'cpln provider', 'terraform registry', 'gitops', 'opentofu', 'install terraform']
---
