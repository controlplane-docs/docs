---
title: Compliance
description: Control Plane's security certifications and compliance standards including PCI DSS, SOC 2, HIPAA, and GDPR.
keywords: ['iso', 'audit report', 'attestation', 'aoc', 'penetration test', 'data protection', 'data isolation', 'trust center', 'secure development', 'encryption at rest', 'multi-tenant', 'owasp']
---
...
management to ensure the platform remains secure for all of our users.

<Info>
  For a copy of our PCI Attestation of Compliance (AoC), please contact [support@controlplane.com](mailto:support@controlplane.com).
</Info>
...
<Card
  title="Download PCI Responsibility Matrix"
  icon="download"
  horizontal
  href="https://controlplane.com/downloads/Control_Plane_PCI_Responsibilities_Matrix.pdf"
></Card>
...
<img src="/images/compliance/aicpa-soc.png" alt="AICPA SOC for Service Organizations" width="120" />
...
<CardGroup cols={2}>
  <Card title="Security" icon="shield-halved" href="/core/security">
    How the platform handles authentication, authorization, TLS certificates, and cipher configuration.
  </Card>
  <Card title="Audit Trail" icon="magnifying-glass" href="/core/audittrail">
    Every action on every interface, recorded tamper-proof and queryable.
  </Card>
</CardGroup>
