...
description: Install, upgrade, and manage Control Plane Template Catalog releases using the Terraform provider. Covers prerequisites, cpln_catalog_template resource configuration, and lifecycle management.
keywords: ['tf template', 'terraform module', 'hcl template', 'terraform apply', 'iac template', 'terraform deploy', 'cpln_catalog_template', 'terraform provider', 'main.tf']
---
...
<Steps>
  ...
  <Step title="Define the Resource">
    ...
    - **template** — The name of the catalog template (e.g., `cockroach`).
