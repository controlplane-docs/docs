...
sidebarTitle: Pulumi
description: Install, upgrade, and manage Control Plane Template Catalog releases using the Pulumi provider. Covers prerequisites, CatalogTemplate resource configuration, and lifecycle management.
keywords: ['pulumi template', 'iac template', 'typescript template', 'python template', 'pulumi up', 'pulumi stack', 'programmatic deploy', 'catalogtemplate', 'pulumi provider', 'go sdk', 'csharp sdk']
---
