...
<Steps>
  <Step title="Choose a Template">
    Browse the available templates in the catalog and identify the template name and version you want to install. These items can be found in the [UI](/template-catalog/install-manage/ui) or the [template repo](https://github.com/controlplane-com/templates). 
  </Step>
