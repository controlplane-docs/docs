---
title: 'Cassandra'
icon: /template-catalog/templates/icons/cassandra.png
description: 'Deploy an Apache Cassandra 5.0 cluster on Control Plane using the Template Catalog. Covers replication factor, multi-zone placement, scheduled repair, and logical or physical backups to S3 or GCS.'
keywords: ['nosql', 'cql', 'cqlsh', 'nodetool', 'sstable', 'token ring', 'keyspace', 'anti-entropy repair', 'stateful workload', 'volume set', 'wide column', 'distributed database']
---
