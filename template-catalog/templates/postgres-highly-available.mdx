...
description: Deploy PostgreSQL Highly Available on Control Plane using the Template Catalog. Covers configuration, volumes, scaling, and Patroni clustering with etcd consensus and HAProxy.
