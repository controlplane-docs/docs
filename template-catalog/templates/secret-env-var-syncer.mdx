...
icon: /template-catalog/templates/icons/sevs.png
description: 'Deploy the Secret Env Var Syncer on Control Plane using the Template Catalog. A cron workload that syncs dictionary secret keys to GVC and workload environment variables as secret references on a schedule.'
keywords: ['SEVS', 'injection', 'config.yaml', 'cpln://secret', 'idempotent', 'reveal', 'automation', 'scheduled job']
---
