---
title: FusionAuth
icon: /template-catalog/templates/icons/fusionauth.png
description: Deploy FusionAuth on Control Plane using the Template Catalog. Covers configuration, volumes, scaling, and identity management with PostgreSQL and optional backups.
keywords: ['auth server', 'oauth2', 'oidc', 'saml', 'sso', 'auth0 alternative', 'keycloak alternative', 'okta alternative', 'mfa', 'user database', 'idp']
---
