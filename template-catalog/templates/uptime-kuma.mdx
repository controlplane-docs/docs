...
keywords: ['pingdom alternative', 'uptimerobot alternative', 'statuspage alternative', 'better stack alternative', 'synthetic monitoring', 'health checks', 'heartbeat', 'alerting', 'slack alerts', 'webhook', 'icmp', 'sqlite', 'kuma template']
---
...
- `resources` — CPU and memory for the Uptime Kuma container. The defaults comfortably cover tens of monitors.
