---
title: Ollama
icon: /template-catalog/templates/icons/ollama.png
description: Deploy Ollama on Control Plane using the Template Catalog. Covers configuration, volumes, scaling, and LLM serving with Open WebUI sidecar and automatic model pulling.
keywords: ['local llm', 'self-hosted ai', 'on-prem ai', 'open source llm', 'llama', 'mistral', 'qwen', 'gemma', 'inference server', 'gpu workload', 'private ai', 'chat ui']
---
