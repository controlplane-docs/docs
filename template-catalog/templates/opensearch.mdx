---
title: OpenSearch
icon: /template-catalog/templates/icons/opensearch.png
description: Deploy OpenSearch on Control Plane using the Template Catalog. Covers configuration, volumes, scaling, and distributed search clustering with optional Dashboards and S3/GCS backups.
keywords: ['elasticsearch fork', 'log search', 'lucene', 'elk alternative', 'kibana alternative', 'es alternative', 'analytics db', 'aws opensearch', 'snapshot repository', 'index lifecycle']
---
