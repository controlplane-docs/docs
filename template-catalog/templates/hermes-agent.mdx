---
title: Hermes Agent
icon: /template-catalog/templates/icons/hermes-agent.png
...
keywords: ['nous research', 'self-hosted agent', 'autonomous agent', 'llm wrapper', 'anthropic', 'claude', 'gpt-5', 'openrouter', 'vllm', 'lm studio', 'agent gateway', 'bearer token', 'reasoning effort', 'webhooks', 'browser automation', 'whatsapp', 'telegram', 'mcp', 'model context protocol', 'chatgpt alternative']
---
