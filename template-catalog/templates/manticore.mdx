...
icon: /template-catalog/templates/icons/manticore.png
description: Deploy Manticore Search on Control Plane using the Template Catalog. Covers configuration, volumes, scaling, and distributed Galera clustering with orchestrator API and S3 imports.
keywords: ['full text search', 'sphinx fork', 'elasticsearch alternative', 'meilisearch alternative', 'typesense alternative', 'inverted index', 'search index', 'sql full text', 'opensearch alternative']
---
