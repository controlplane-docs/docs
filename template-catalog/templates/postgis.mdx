---
title: PostGIS
icon: /template-catalog/templates/icons/postgis.png
...
- `internalAccess.type` — Controls which workloads can connect to PostGIS on port `5432`:
...
<CardGroup cols={2}>
    <Card title="PostGIS Documentation" icon="book" href="https://postgis.net/documentation/">
    ...
    <Card title="PostGIS Template" icon="github" href="https://github.com/controlplane-com/templates/tree/main/postgis">
