---
title: Redis Cluster
description: Deploy Redis Cluster on Control Plane using the Template Catalog. Covers configuration, volumes, scaling, and native data sharding across multiple primary nodes with replication.
keywords: ['redis sharded', 'hash slot', 'cluster mode', 'kv distributed', 'horizontal redis', 'crc16', 'cluster slots', 'redis-cli', 'cache cluster']
---
