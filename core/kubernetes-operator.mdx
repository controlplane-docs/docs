...
description: Manage Control Plane resources as Kubernetes CRDs for GitOps workflows with ArgoCD. Supports GVCs, workloads, identities, secrets, policies, domains, and cloud accounts.
...
<Accordion title="CRD structure">
  ...
  Always use the [export feature](#exporting-resources-as-crds) to generate accurate CRD manifests.
</Accordion>
...
The operator watches for CRD changes and synchronizes them to Control Plane automatically. You can organize resources by namespace:
