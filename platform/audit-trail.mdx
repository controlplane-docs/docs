...
The architecture of the audit trail is generic and allows any [workload](/objects/workload) to capture any action securely and reliably.

For your workload to use the audit trail, it must first create an [audit context](/objects/auditcontext). Refer to the audit context reference page for additional details.
...
- The Control Plane Audit Trail UI:
  - Within the UI, you can select the audit context and only view those actions.
