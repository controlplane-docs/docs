...
After successful authentication, users' access privileges are determined based on their assigned [group](/objects/group) membership or [policy](/objects/policy).
