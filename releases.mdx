---
title: Release Notes
description: Latest features, updates, and changes across all Control Plane products including the platform, CLI, and Terraform provider.
keywords: ['changelog', 'whats new', 'product updates', 'rss feed', 'announcements', 'version history', 'cli releases', 'terraform changelog']
---
