...
Please refer to the [audit trail](audittrail) reference page for additional details on how to query the audit trail and how to securely capture actions for your workloads.

## Create an Audit Context

Refer to the [Create an Audit Context](/guides/create-resources/create-audit-context) guide for additional details.
