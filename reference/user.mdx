---
title: User
description: "User management within organizations. Covers invitations, multi-org membership, built-in tags, and access control for org members."
keywords: ['invite', 'sso user', 'member', 'principal', 'cpln user', 'human account', 'developer account', 'add user', 'remove user']
---
