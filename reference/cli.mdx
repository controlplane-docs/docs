...
```text Output
{
  "agentId": "4fd9096c-5323-4682-b62a-b2f92496caee",
  "agentLink": "/org/demo-cpln-organization/agent/demo-agent",
  "hubEndpoint": "https://hub.test.cpln.io",
  "registrationToken": "a2P1zEGxHjIk0zJdoFYE4T5uFrSC_JSjGHxf3A32rWCeUSGtAXKNcj-A/iEkb8L"
}
```
...
Refer to the [cpln apply guide](/guides/cli/cpln-apply) for additional details.
...
Refer to the [cpln delete guide](/guides/cli/cpln-delete) for additional details.
...
|---------|------------|--------------|--------------|----------|-----------------|--------------|
|demo-gvc |demo-gvc    |2 minutes ago |g1n2e0026zan0 |          |aws-eu-central-1 |drink="water" |
|         |            |              |              |          |aws-us-west-2    |              |
+---------+------------+--------------+--------------+----------+-----------------+--------------+
```
...
|NAME           |DESCRIPTION       |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS          |
|---------------|------------------|--------------|--------------|----------|-----------------|--------------|
|demo-gvc-clone |Clone of demo-gvc |0 minutes ago |ewacet497g2sc |          |aws-eu-central-1 |drink="water" |
|               |                  |              |              |          |aws-us-west-2    |              |
|               |                  |              |              |          |gcp-us-east1     |              |
+---------------+------------------+--------------+--------------+----------+-----------------+--------------+
```
...
|NAME     |DESCRIPTION |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS          |
|---------|------------|--------------|--------------|----------|-----------------|--------------|
|demo-gvc |demo-gvc    |0 minutes ago |g1n2e0026zan0 |          |aws-eu-central-1 |drink="water" |
+---------+------------+--------------+--------------+----------+-----------------+--------------+
```
...
|------------|------------|------------------------|----------|--------------|---------------------------------------------|-----|
|workload-01 |workload-01 |demo-gvc-with-workloads |          |0 minutes ago |https://workload-01-tpn7fp3xg0c98.t.cpln.app |     |
|workload-02 |workload-02 |demo-gvc-with-workloads |          |0 minutes ago |https://workload-02-tpn7fp3xg0c98.t.cpln.app |     |
+------------+------------+------------------------+----------+--------------+---------------------------------------------+-----+
```
...
|                        |                        |              |              |          |aws-us-west-2    |              |
|                        |                        |              |              |          |gcp-us-east1     |              |
|demo-gvc-get-1          |demo-gvc-get-1          |0 minutes ago |8fwxvmp19213a |          |aws-eu-central-1 |              |
|demo-gvc-get-2          |demo-gvc-get-2          |0 minutes ago |z40jgjrdwapbc |          |aws-eu-central-1 |              |
|demo-gvc-identity       |demo-gvc-identity       |2 minutes ago |1s2dhas2bb10c |          |aws-eu-central-1 |              |
|demo-gvc-with-workloads |demo-gvc-with-workloads |0 minutes ago |tpn7fp3xg0c98 |          |aws-eu-central-1 |              |
|demo-gvc-workload       |demo-gvc-workload       |2 minutes ago |29fn464bvay84 |          |aws-eu-central-1 |              |
+------------------------+------------------------+--------------+--------------+----------+-----------------+--------------+
```
...
|NAME                    |DESCRIPTION             |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS |
|------------------------|------------------------|--------------|--------------|----------|-----------------|-----|
|demo-gvc-with-locations |demo-gvc-with-locations |0 minutes ago |hwdryddpb21wa |          |aws-eu-central-1 |     |
|                        |                        |              |              |          |aws-us-west-2    |     |
|                        |                        |              |              |          |gcp-us-east1     |     |
+------------------------+------------------------+--------------+--------------+----------+-----------------+-----+
```
...
|NAME                    |DESCRIPTION             |CREATED       |ALIAS         |DOMAIN    |LOCATIONS    |TAGS |
|------------------------|------------------------|--------------|--------------|----------|-------------|-----|
|demo-gvc-with-locations |demo-gvc-with-locations |0 minutes ago |hwdryddpb21wa |          |gcp-us-east1 |     |
+------------------------+------------------------+--------------+--------------+----------+-------------+-----+
```
...
|NAME           |DESCRIPTION    |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS          |
|---------------|---------------|--------------|--------------|----------|-----------------|--------------|
|demo-gvc-tag-1 |demo-gvc-tag-1 |0 minutes ago |kjjs0h80y0mr0 |          |aws-eu-central-1 |drink="water" |
+---------------+---------------+--------------+--------------+----------+-----------------+--------------+
```
...
|NAME           |DESCRIPTION    |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS           |
|---------------|---------------|--------------|--------------|----------|-----------------|---------------|
|demo-gvc-tag-1 |demo-gvc-tag-1 |0 minutes ago |kjjs0h80y0mr0 |          |aws-eu-central-1 |drink="coffee" |
+---------------+---------------+--------------+--------------+----------+-----------------+---------------+
```
...
|NAME           |DESCRIPTION    |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS |
|---------------|---------------|--------------|--------------|----------|-----------------|-----|
|demo-gvc-tag-1 |demo-gvc-tag-1 |0 minutes ago |kjjs0h80y0mr0 |          |aws-eu-central-1 |     |
+---------------+---------------+--------------+--------------+----------+-----------------+-----+
```
...
|NAME           |DESCRIPTION    |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS                 |
|---------------|---------------|--------------|--------------|----------|-----------------|---------------------|
|demo-gvc-tag-1 |demo-gvc-tag-1 |0 minutes ago |kjjs0h80y0mr0 |          |aws-eu-central-1 |multiple-gvcs="true" |
|demo-gvc-tag-2 |demo-gvc-tag-2 |0 minutes ago |245q46rc6fgaj |          |aws-eu-central-1 |multiple-gvcs="true" |
+---------------+---------------+--------------+--------------+----------+-----------------+---------------------+
```
...
|NAME           |DESCRIPTION    |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS                     |
|---------------|---------------|--------------|--------------|----------|-----------------|-------------------------|
|demo-gvc-tag-1 |demo-gvc-tag-1 |0 minutes ago |kjjs0h80y0mr0 |          |aws-eu-central-1 |multiple-gvcs="demo-gvc" |
|demo-gvc-tag-2 |demo-gvc-tag-2 |0 minutes ago |245q46rc6fgaj |          |aws-eu-central-1 |multiple-gvcs="demo-gvc" |
+---------------+---------------+--------------+--------------+----------+-----------------+-------------------------+
```
...
|---------------|---------------|--------------|--------------|----------|-----------------|-----|
|demo-gvc-tag-1 |demo-gvc-tag-1 |0 minutes ago |kjjs0h80y0mr0 |          |aws-eu-central-1 |     |
|demo-gvc-tag-2 |demo-gvc-tag-2 |0 minutes ago |245q46rc6fgaj |          |aws-eu-central-1 |     |
+---------------+---------------+--------------+--------------+----------+-----------------+-----+
```
...
|NAME            |DESCRIPTION     |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS |
|----------------|----------------|--------------|--------------|----------|-----------------|-----|
|demo-gvc-update |demo-gvc-update |0 minutes ago |5pkgcg0qr0gse |          |aws-eu-central-1 |     |
+----------------+----------------+--------------+--------------+----------+-----------------+-----+
```
...
|NAME            |DESCRIPTION     |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS |
|----------------|----------------|--------------|--------------|----------|-----------------|-----|
|demo-gvc-update |new description |0 minutes ago |5pkgcg0qr0gse |          |aws-eu-central-1 |     |
+----------------+----------------+--------------+--------------+----------+-----------------+-----+
```
...
|NAME            |DESCRIPTION     |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS                  |
|----------------|----------------|--------------|--------------|----------|-----------------|----------------------|
|demo-gvc-update |new description |0 minutes ago |5pkgcg0qr0gse |          |aws-eu-central-1 |demo-key="demo-value" |
+----------------+----------------+--------------+--------------+----------+-----------------+----------------------+
```
...
Refer to the [cpln helm guide](/guides/cli/cpln-helm) for additional details.
...
|--------------|--------------|------------------|-------------------------------|--------------|----------|--------------|
|demo-identity |demo-identity |demo-gvc-identity |cpln-demo-cpln-organi-f9n4x6ry |0 minutes ago |          |drink="water" |
+--------------+--------------+------------------+-------------------------------+--------------+----------+--------------+
```
...
|NAME                |DESCRIPTION         |GVC               |LOCAL NAME                     |CREATED       |PROVIDERS |TAGS          |
|--------------------|--------------------|------------------|-------------------------------|--------------|----------|--------------|
|demo-identity-get-1 |demo-identity-get-1 |demo-gvc-identity |cpln-demo-cpln-organi-ehd3g6na |0 minutes ago |          |              |
|demo-identity-get-2 |demo-identity-get-2 |demo-gvc-identity |cpln-demo-cpln-organi-yzz992sq |0 minutes ago |          |              |
|demo-identity       |demo-identity       |demo-gvc-identity |cpln-demo-cpln-organi-f9n4x6ry |3 minutes ago |          |drink="water" |
+--------------------+--------------------+------------------+-------------------------------+--------------+----------+--------------+
```
...
|NAME          |DESCRIPTION   |GVC               |LOCAL NAME                     |CREATED       |PROVIDERS |TAGS           |
|--------------|--------------|------------------|-------------------------------|--------------|----------|---------------|
|demo-identity |demo-identity |demo-gvc-identity |cpln-demo-cpln-organi-f9n4x6ry |3 minutes ago |          |drink="coffee" |
+--------------+--------------+------------------+-------------------------------+--------------+----------+---------------+
```
...
|NAME          |DESCRIPTION   |GVC               |LOCAL NAME                     |CREATED       |PROVIDERS |TAGS |
|--------------|--------------|------------------|-------------------------------|--------------|----------|-----|
|demo-identity |demo-identity |demo-gvc-identity |cpln-demo-cpln-organi-f9n4x6ry |3 minutes ago |          |     |
+--------------+--------------+------------------+-------------------------------+--------------+----------+-----+
```
...
|NAME                 |DESCRIPTION          |GVC               |LOCAL NAME                     |CREATED       |PROVIDERS |TAGS |
|---------------------|---------------------|------------------|-------------------------------|--------------|----------|-----|
|demo-identity-update |demo-identity-update |demo-gvc-identity |cpln-demo-cpln-organi-61hrre2r |0 minutes ago |          |     |
+---------------------+---------------------+------------------+-------------------------------+--------------+----------+-----+
```
...
|NAME                 |DESCRIPTION     |GVC               |LOCAL NAME                     |CREATED       |PROVIDERS |TAGS |
|---------------------|----------------|------------------|-------------------------------|--------------|----------|-----|
|demo-identity-update |new description |demo-gvc-identity |cpln-demo-cpln-organi-61hrre2r |0 minutes ago |          |     |
+---------------------+----------------+------------------+-------------------------------+--------------+----------+-----+
```
...
|NAME                 |DESCRIPTION     |GVC               |LOCAL NAME                     |CREATED       |PROVIDERS |TAGS                  |
|---------------------|----------------|------------------|-------------------------------|--------------|----------|----------------------|
|demo-identity-update |new description |demo-gvc-identity |cpln-demo-cpln-organi-61hrre2r |0 minutes ago |          |demo-key="demo-value" |
+---------------------+----------------+------------------+-------------------------------+--------------+----------+----------------------+
```
...
|superusers-spicedbcluster  |Built-in policy granting full access ... |7 months ago  |spicedbcluster  |all     |builtin |              |
...
|viewers-spicedbcluster     |Built-in policy granting read-only ac... |7 months ago  |spicedbcluster  |all     |builtin |              |
...
For a detailed overview, please visit the [manage CLI profiles](/guides/cli/manage-profile) guide.
...
|-------------------------------------|----------------------|-----------------------------------------|--------|--------|-----|----------|----------------------------------|
|06d56a09-48c1-458e-9786-b0fca632e0a6 |workloads-per-gvc     |Max number of workloads in a gvc         |builtin |0       |20   |count     |gvcLink="demo-gvc-with-workloads" |
...
|8b72cf02-6fd0-4db9-b9ac-a53a947df22c |identities-per-gvc    |Max number of workload identities in ... |builtin |4       |20   |count     |gvcLink="demo-gvc-identity"       |
|95e1c354-8ed8-41bf-b27c-c97153a4136e |workloads-per-gvc     |Max number of workloads in a gvc         |builtin |1       |20   |count     |gvcLink="demo-gvc-workload"       |
...
```text Output
{
  ...
  "created": "2024-06-08T22:44:00.930Z",
  "key": "slBt0VJGOapEuiuo.ZGVtby1jcGxuLW9yZ2FuaXphdGlvbi5kZW1vLXNlcnZpY2UtYWNjb3VudC5zNV95dWhlY25fZmtGMEhRa3ZRV0E5NHlKUmlCM1M4T0NGRF9DMl9hRmlZ.LVqFfHjLWlX6pHV2IiGjFF-Ok1Z04dNw_5kxskfE9L8"
}
```
...
|cpln-user                  |cpln-user                                |8 months ago  |default |sOajhentlsc226k8 |              |
|demo-service-account       |demo-service-account                     |5 minutes ago |default |slBt0VJGOapEuiuo |drink="water" |
...
```bash Command
cpln serviceaccount remove-key demo-service-account --key sL0syojkchleXnfA --org demo-cpln-organization
```
...
Refer to the [Compose Deploy guide](/guides/cli/compose-deploy) for additional details.
...
Refer to the [compose deploy guide](/guides/cli/compose-deploy) for more details.
...
|NAME                |DESCRIPTION            |GVC               |READY     |CREATED       |ENDPOINT                                             |TAGS          |
|--------------------|-----------------------|------------------|----------|--------------|-----------------------------------------------------|--------------|
|demo-workload-clone |Clone of demo-workload |demo-gvc-workload |          |0 minutes ago |https://demo-workload-clone-29fn464bvay84.t.cpln.app |drink="water" |
+--------------------+-----------------------+------------------+----------+--------------+-----------------------------------------------------+--------------+
```
...
|NAME          |DESCRIPTION   |GVC               |READY     |CREATED       |ENDPOINT                                       |TAGS          |
|--------------|--------------|------------------|----------|--------------|-----------------------------------------------|--------------|
|demo-workload |demo-workload |demo-gvc-workload |          |0 minutes ago |https://demo-workload-29fn464bvay84.t.cpln.app |drink="water" |
+--------------+--------------+------------------+----------+--------------+-----------------------------------------------+--------------+
```
...
|NAME                |DESCRIPTION         |GVC               |READY |CREATED       |ENDPOINT                                             |TAGS          |
|--------------------|--------------------|------------------|------|--------------|-----------------------------------------------------|--------------|
|demo-workload-get-1 |demo-workload-get-1 |demo-gvc-workload |false |0 minutes ago |https://demo-workload-get-1-29fn464bvay84.t.cpln.app |              |
|demo-workload-get-2 |demo-workload-get-2 |demo-gvc-workload |false |0 minutes ago |https://demo-workload-get-2-29fn464bvay84.t.cpln.app |              |
|demo-workload       |demo-workload       |demo-gvc-workload |true  |6 minutes ago |https://demo-workload-29fn464bvay84.t.cpln.app       |drink="water" |
+--------------------+--------------------+------------------+------+--------------+-----------------------------------------------------+--------------+
```
...
|NAME                |DESCRIPTION         |GVC               |READY     |CREATED       |ENDPOINT                                             |TAGS          |
|--------------------|--------------------|------------------|----------|--------------|-----------------------------------------------------|--------------|
|demo-workload-get-1 |demo-workload-get-1 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-get-1-29fn464bvay84.t.cpln.app |              |
|demo-workload-get-2 |demo-workload-get-2 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-get-2-29fn464bvay84.t.cpln.app |              |
|demo-workload       |demo-workload       |demo-gvc-workload |          |6 minutes ago |https://demo-workload-29fn464bvay84.t.cpln.app       |drink="water" |
+--------------------+--------------------+------------------+----------+--------------+-----------------------------------------------------+--------------+
```
...
|NAME                |DESCRIPTION         |GVC               |READY     |CREATED       |ENDPOINT                                             |TAGS          |
|--------------------|--------------------|------------------|----------|--------------|-----------------------------------------------------|--------------|
|demo-workload-tag-1 |demo-workload-tag-1 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-1-29fn464bvay84.t.cpln.app |drink="water" |
+--------------------+--------------------+------------------+----------+--------------+-----------------------------------------------------+--------------+
```
...
|NAME                |DESCRIPTION         |GVC               |READY     |CREATED       |ENDPOINT                                             |TAGS           |
|--------------------|--------------------|------------------|----------|--------------|-----------------------------------------------------|---------------|
|demo-workload-tag-1 |demo-workload-tag-1 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-1-29fn464bvay84.t.cpln.app |drink="coffee" |
+--------------------+--------------------+------------------+----------+--------------+-----------------------------------------------------+---------------+
```
...
|NAME                |DESCRIPTION         |GVC               |READY     |CREATED       |ENDPOINT                                             |TAGS |
|--------------------|--------------------|------------------|----------|--------------|-----------------------------------------------------|-----|
|demo-workload-tag-1 |demo-workload-tag-1 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-1-29fn464bvay84.t.cpln.app |     |
+--------------------+--------------------+------------------+----------+--------------+-----------------------------------------------------+-----+
```
...
|NAME                |DESCRIPTION         |GVC               |READY     |CREATED       |ENDPOINT                                             |TAGS                      |
|--------------------|--------------------|------------------|----------|--------------|-----------------------------------------------------|--------------------------|
|demo-workload-tag-1 |demo-workload-tag-1 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-1-29fn464bvay84.t.cpln.app |multiple-workloads="true" |
|demo-workload-tag-2 |demo-workload-tag-2 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-2-29fn464bvay84.t.cpln.app |multiple-workloads="true" |
+--------------------+--------------------+------------------+----------+--------------+-----------------------------------------------------+--------------------------+
```
...
|NAME                |DESCRIPTION         |GVC               |READY     |CREATED       |ENDPOINT                                             |TAGS                               |
|--------------------|--------------------|------------------|----------|--------------|-----------------------------------------------------|-----------------------------------|
|demo-workload-tag-1 |demo-workload-tag-1 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-1-29fn464bvay84.t.cpln.app |multiple-workloads="demo-workload" |
|demo-workload-tag-2 |demo-workload-tag-2 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-2-29fn464bvay84.t.cpln.app |multiple-workloads="demo-workload" |
+--------------------+--------------------+------------------+----------+--------------+-----------------------------------------------------+-----------------------------------+
```
...
|--------------------|--------------------|------------------|----------|--------------|-----------------------------------------------------|-----|
|demo-workload-tag-1 |demo-workload-tag-1 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-1-29fn464bvay84.t.cpln.app |     |
|demo-workload-tag-2 |demo-workload-tag-2 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-2-29fn464bvay84.t.cpln.app |     |
+--------------------+--------------------+------------------+----------+--------------+-----------------------------------------------------+-----+
```
...
|NAME                 |DESCRIPTION          |GVC               |READY     |CREATED       |ENDPOINT                                              |TAGS |
|---------------------|---------------------|------------------|----------|--------------|------------------------------------------------------|-----|
|demo-workload-update |demo-workload-update |demo-gvc-workload |          |0 minutes ago |https://demo-workload-update-29fn464bvay84.t.cpln.app |     |
+---------------------+---------------------+------------------+----------+--------------+------------------------------------------------------+-----+
```
...
|NAME                 |DESCRIPTION     |GVC               |READY     |CREATED       |ENDPOINT                                              |TAGS |
|---------------------|----------------|------------------|----------|--------------|------------------------------------------------------|-----|
|demo-workload-update |new description |demo-gvc-workload |          |0 minutes ago |https://demo-workload-update-29fn464bvay84.t.cpln.app |     |
+---------------------+----------------+------------------+----------+--------------+------------------------------------------------------+-----+
```
...
|NAME                 |DESCRIPTION     |GVC               |READY     |CREATED       |ENDPOINT                                              |TAGS                  |
|---------------------|----------------|------------------|----------|--------------|------------------------------------------------------|----------------------|
|demo-workload-update |new description |demo-gvc-workload |          |0 minutes ago |https://demo-workload-update-29fn464bvay84.t.cpln.app |demo-key="demo-value" |
+---------------------+----------------+------------------+----------+--------------+------------------------------------------------------+----------------------+
```
