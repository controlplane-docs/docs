...
[macOS-arm64](https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/1373977017-e608568e/cpln-macos-arm64.dmg)

[macOS-x64](https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/1373977017-e608568e/cpln-macos-x64.dmg)

[Linux](https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/1373977017-e608568e/cpln-linux.tgz)

[Windows](https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/1373977017-e608568e/cpln-win.zip)

<Accordion title="View Checksum">

| OS            | File                 | sha256               |
| ------------- | -------------------- | -------------------- |
| macOS-arm64   | cpln-macos-arm64.dmg | c3d25d5a1ce0f80320104b0655d092d8f57ebcc0a436024aa46bd3686654379e |
| macOS-x64     | cpln-macos-x64.dmg   | 0dda7d63b16c53abb1e38661a99556de1b771046cc02e6869753ab0ce8c3efbb   |
| Linux         | cpln-linux.tgz       | 658edacbed809b18d0fcb61efc4c98af96cdb3d10440cfa44c4a30f76dc36bfe       |
| Windows 10/11 | cpln-win.zip         | cec0437d2e01158e6b4bd709ce3b9c35b0ed62ad19357e08236a06ca528d042a     |
...
```text Output
{
  "agentId": "695029df-cc1b-4282-bac5-0577ba255a2f",
  "agentLink": "/org/demo-cpln-organization/agent/demo-agent",
  "hubEndpoint": "https://hub.test.cpln.io",
  "registrationToken": "a2aeb72MNSLSujatHgI0rZLF_AYv0HfPMI7X7ePHw4Le__KN2qCLBxFg/ycZrgF"
}
```
...
Allows you to copy files and directories to and from workloads
...
```text
Positionals:
  file-spec-src   A path to the source file or directory to copy from. This can be either a local path on your machine or a path within a workload  [string] [required]
  file-spec-dest  A path to the destination file or directory to copy to. This can be either a local path on your machine or a path within a workload  [string] [required]
...
|---------|------------|--------------|--------------|----------|-----------------|--------------|
|demo-gvc |demo-gvc    |2 minutes ago |js99w4m2c4wda |          |aws-eu-central-1 |drink="water" |
|         |            |              |              |          |aws-us-west-2    |              |
+---------+------------+--------------+--------------+----------+-----------------+--------------+
```
...
|NAME           |DESCRIPTION       |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS          |
|---------------|------------------|--------------|--------------|----------|-----------------|--------------|
|demo-gvc-clone |Clone of demo-gvc |0 minutes ago |62p9p4hfkb7qa |          |aws-eu-central-1 |drink="water" |
|               |                  |              |              |          |aws-us-west-2    |              |
|               |                  |              |              |          |gcp-us-east1     |              |
+---------------+------------------+--------------+--------------+----------+-----------------+--------------+
```
...
|NAME     |DESCRIPTION |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS          |
|---------|------------|--------------|--------------|----------|-----------------|--------------|
|demo-gvc |demo-gvc    |0 minutes ago |js99w4m2c4wda |          |aws-eu-central-1 |drink="water" |
+---------+------------+--------------+--------------+----------+-----------------+--------------+
```
...
|------------|------------|------------------------|----------|--------------|---------------------------------------------|-----|
|workload-01 |workload-01 |demo-gvc-with-workloads |          |0 minutes ago |https://workload-01-y81t1rr4kfjc0.t.cpln.app |     |
|workload-02 |workload-02 |demo-gvc-with-workloads |          |0 minutes ago |https://workload-02-y81t1rr4kfjc0.t.cpln.app |     |
+------------+------------+------------------------+----------+--------------+---------------------------------------------+-----+
```
...
|NAME                    |DESCRIPTION             |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS          |
|------------------------|------------------------|--------------|--------------|----------|-----------------|--------------|
|demo-gvc                |demo-gvc                |3 minutes ago |js99w4m2c4wda |          |aws-eu-central-1 |drink="water" |
|                        |                        |              |              |          |aws-us-west-2    |              |
|                        |                        |              |              |          |gcp-us-east1     |              |
|demo-gvc-get-1          |demo-gvc-get-1          |0 minutes ago |dbgzm1a60qfsc |          |aws-eu-central-1 |              |
|demo-gvc-get-2          |demo-gvc-get-2          |0 minutes ago |znc4vxmfhev9a |          |aws-eu-central-1 |              |
|demo-gvc-identity       |demo-gvc-identity       |3 minutes ago |6n4kq5wgfnppr |          |aws-eu-central-1 |              |
|demo-gvc-with-workloads |demo-gvc-with-workloads |0 minutes ago |y81t1rr4kfjc0 |          |aws-eu-central-1 |              |
|demo-gvc-workload       |demo-gvc-workload       |3 minutes ago |y2bm6g4fkqt8w |          |aws-eu-central-1 |              |
+------------------------+------------------------+--------------+--------------+----------+-----------------+--------------+
```
...
|NAME                    |DESCRIPTION             |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS |
|------------------------|------------------------|--------------|--------------|----------|-----------------|-----|
|demo-gvc-with-locations |demo-gvc-with-locations |0 minutes ago |b5w9cvb1x10h8 |          |aws-eu-central-1 |     |
|                        |                        |              |              |          |aws-us-west-2    |     |
|                        |                        |              |              |          |gcp-us-east1     |     |
+------------------------+------------------------+--------------+--------------+----------+-----------------+-----+
```
...
|NAME                    |DESCRIPTION             |CREATED       |ALIAS         |DOMAIN    |LOCATIONS    |TAGS |
|------------------------|------------------------|--------------|--------------|----------|-------------|-----|
|demo-gvc-with-locations |demo-gvc-with-locations |0 minutes ago |b5w9cvb1x10h8 |          |gcp-us-east1 |     |
+------------------------+------------------------+--------------+--------------+----------+-------------+-----+
```
...
|NAME           |DESCRIPTION    |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS          |
|---------------|---------------|--------------|--------------|----------|-----------------|--------------|
|demo-gvc-tag-1 |demo-gvc-tag-1 |0 minutes ago |ftjh6mr3sn9dy |          |aws-eu-central-1 |drink="water" |
+---------------+---------------+--------------+--------------+----------+-----------------+--------------+
```
...
|NAME           |DESCRIPTION    |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS           |
|---------------|---------------|--------------|--------------|----------|-----------------|---------------|
|demo-gvc-tag-1 |demo-gvc-tag-1 |0 minutes ago |ftjh6mr3sn9dy |          |aws-eu-central-1 |drink="coffee" |
+---------------+---------------+--------------+--------------+----------+-----------------+---------------+
```
...
|NAME           |DESCRIPTION    |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS |
|---------------|---------------|--------------|--------------|----------|-----------------|-----|
|demo-gvc-tag-1 |demo-gvc-tag-1 |0 minutes ago |ftjh6mr3sn9dy |          |aws-eu-central-1 |     |
+---------------+---------------+--------------+--------------+----------+-----------------+-----+
```
...
|NAME           |DESCRIPTION    |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS                 |
|---------------|---------------|--------------|--------------|----------|-----------------|---------------------|
|demo-gvc-tag-1 |demo-gvc-tag-1 |0 minutes ago |ftjh6mr3sn9dy |          |aws-eu-central-1 |multiple-gvcs="true" |
|demo-gvc-tag-2 |demo-gvc-tag-2 |0 minutes ago |9vzgm6tz1vwzp |          |aws-eu-central-1 |multiple-gvcs="true" |
+---------------+---------------+--------------+--------------+----------+-----------------+---------------------+
```
...
|NAME           |DESCRIPTION    |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS                     |
|---------------|---------------|--------------|--------------|----------|-----------------|-------------------------|
|demo-gvc-tag-1 |demo-gvc-tag-1 |0 minutes ago |ftjh6mr3sn9dy |          |aws-eu-central-1 |multiple-gvcs="demo-gvc" |
|demo-gvc-tag-2 |demo-gvc-tag-2 |0 minutes ago |9vzgm6tz1vwzp |          |aws-eu-central-1 |multiple-gvcs="demo-gvc" |
+---------------+---------------+--------------+--------------+----------+-----------------+-------------------------+
```
...
|---------------|---------------|--------------|--------------|----------|-----------------|-----|
|demo-gvc-tag-1 |demo-gvc-tag-1 |0 minutes ago |ftjh6mr3sn9dy |          |aws-eu-central-1 |     |
|demo-gvc-tag-2 |demo-gvc-tag-2 |0 minutes ago |9vzgm6tz1vwzp |          |aws-eu-central-1 |     |
+---------------+---------------+--------------+--------------+----------+-----------------+-----+
```
...
|NAME            |DESCRIPTION     |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS |
|----------------|----------------|--------------|--------------|----------|-----------------|-----|
|demo-gvc-update |demo-gvc-update |0 minutes ago |r683nkeanwcea |          |aws-eu-central-1 |     |
+----------------+----------------+--------------+--------------+----------+-----------------+-----+
```
...
|NAME            |DESCRIPTION     |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS |
|----------------|----------------|--------------|--------------|----------|-----------------|-----|
|demo-gvc-update |new description |0 minutes ago |r683nkeanwcea |          |aws-eu-central-1 |     |
+----------------+----------------+--------------+--------------+----------+-----------------+-----+
```
...
|NAME            |DESCRIPTION     |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS                  |
|----------------|----------------|--------------|--------------|----------|-----------------|----------------------|
|demo-gvc-update |new description |0 minutes ago |r683nkeanwcea |          |aws-eu-central-1 |demo-key="demo-value" |
+----------------+----------------+--------------+--------------+----------+-----------------+----------------------+
```
...
|--------------|--------------|------------------|-------------------------------|--------------|----------|--------------|
|demo-identity |demo-identity |demo-gvc-identity |cpln-demo-cpln-organi-0rw86pmb |0 minutes ago |          |drink="water" |
+--------------+--------------+------------------+-------------------------------+--------------+----------+--------------+
```
...
|NAME                |DESCRIPTION         |GVC               |LOCAL NAME                     |CREATED       |PROVIDERS |TAGS          |
|--------------------|--------------------|------------------|-------------------------------|--------------|----------|--------------|
|demo-identity-get-2 |demo-identity-get-2 |demo-gvc-identity |cpln-demo-cpln-organi-5qpas119 |0 minutes ago |          |              |
|demo-identity       |demo-identity       |demo-gvc-identity |cpln-demo-cpln-organi-0rw86pmb |3 minutes ago |          |drink="water" |
|demo-identity-get-1 |demo-identity-get-1 |demo-gvc-identity |cpln-demo-cpln-organi-br4nqhx6 |0 minutes ago |          |              |
+--------------------+--------------------+------------------+-------------------------------+--------------+----------+--------------+
```
...
|NAME          |DESCRIPTION   |GVC               |LOCAL NAME                     |CREATED       |PROVIDERS |TAGS           |
|--------------|--------------|------------------|-------------------------------|--------------|----------|---------------|
|demo-identity |demo-identity |demo-gvc-identity |cpln-demo-cpln-organi-0rw86pmb |3 minutes ago |          |drink="coffee" |
+--------------+--------------+------------------+-------------------------------+--------------+----------+---------------+
```
...
|NAME          |DESCRIPTION   |GVC               |LOCAL NAME                     |CREATED       |PROVIDERS |TAGS |
|--------------|--------------|------------------|-------------------------------|--------------|----------|-----|
|demo-identity |demo-identity |demo-gvc-identity |cpln-demo-cpln-organi-0rw86pmb |3 minutes ago |          |     |
+--------------+--------------+------------------+-------------------------------+--------------+----------+-----+
```
...
|NAME                 |DESCRIPTION          |GVC               |LOCAL NAME                     |CREATED       |PROVIDERS |TAGS |
|---------------------|---------------------|------------------|-------------------------------|--------------|----------|-----|
|demo-identity-update |demo-identity-update |demo-gvc-identity |cpln-demo-cpln-organi-93rnxtbp |0 minutes ago |          |     |
+---------------------+---------------------+------------------+-------------------------------+--------------+----------+-----+
```
...
|NAME                 |DESCRIPTION     |GVC               |LOCAL NAME                     |CREATED       |PROVIDERS |TAGS |
|---------------------|----------------|------------------|-------------------------------|--------------|----------|-----|
|demo-identity-update |new description |demo-gvc-identity |cpln-demo-cpln-organi-93rnxtbp |0 minutes ago |          |     |
+---------------------+----------------+------------------+-------------------------------+--------------+----------+-----+
```
...
|NAME                 |DESCRIPTION     |GVC               |LOCAL NAME                     |CREATED       |PROVIDERS |TAGS                  |
|---------------------|----------------|------------------|-------------------------------|--------------|----------|----------------------|
|demo-identity-update |new description |demo-gvc-identity |cpln-demo-cpln-organi-93rnxtbp |0 minutes ago |          |demo-key="demo-value" |
+---------------------+----------------+------------------+-------------------------------+--------------+----------+----------------------+
```
...
|-------------|----------------------------------------------------------|-----------------|-------------|----------------------------|
|demo-image:1 |demo-cpln-organization.registry.test.cpln.io/demo-image:1 |sha256:3fe719... |9 months ago |                            |
...
|NAME         |PULL                                                      |DIGEST           |CREATED      |TAGS          |
|-------------|----------------------------------------------------------|-----------------|-------------|--------------|
|demo-image:1 |demo-cpln-organization.registry.test.cpln.io/demo-image:1 |sha256:3fe719... |9 months ago |drink="water" |
+-------------+----------------------------------------------------------+-----------------+-------------+--------------+
```
...
|NAME         |PULL                                                      |DIGEST           |CREATED      |TAGS           |
|-------------|----------------------------------------------------------|-----------------|-------------|---------------|
|demo-image:1 |demo-cpln-organization.registry.test.cpln.io/demo-image:1 |sha256:3fe719... |9 months ago |drink="coffee" |
+-------------+----------------------------------------------------------+-----------------+-------------+---------------+
```
...
kubectl apply -f 'https://byok-api.test.cpln.io/install/download/xxxxxxxxxx/byok-agent.k8s.yaml'
```
...
kubectl apply -f 'https://byok-api.test.cpln.io/install/download/xxxxxxxxxx/byok-agent-uninstall.k8s.yaml'
```
...
|superusers-spicedbcluster  |Built-in policy granting full access ... |8 months ago  |spicedbcluster  |all     |builtin |              |
...
|viewers-spicedbcluster     |Built-in policy granting read-only ac... |8 months ago  |spicedbcluster  |all     |builtin |              |
...
|2b00e366-9a65-4c22-a992-09c1a7455642 |workloads-per-gvc     |Max number of workloads in a gvc         |builtin |1       |20   |count     |gvcLink="demo-gvc-workload"       |
...
|a9aa9dca-effa-4c15-b95e-7f173f6cd430 |identities-per-gvc    |Max number of workload identities in ... |builtin |4       |20   |count     |gvcLink="demo-gvc-identity"       |
...
|ef0b7617-4fcf-4a44-9b44-896438fdd6a1 |workloads-per-gvc     |Max number of workloads in a gvc         |builtin |0       |20   |count     |gvcLink="demo-gvc-with-workloads" |
+-------------------------------------+----------------------+-----------------------------------------+--------+--------+-----+----------+----------------------------------+
```
...
```text Output
{
  ...
  "created": "2024-07-18T03:42:14.813Z",
  "key": "sGGobUDp52IFGKzE.ZGVtby1jcGxuLW9yZ2FuaXphdGlvbi5kZW1vLXNlcnZpY2UtYWNjb3VudC5jQklEVUZtcVpsX2JnNllTeHdRZ2ZnaDVKTnpoX1FJNTBXRXhBRWtfeWNB.-89c1_mvJleTLcU_tsgyAsPCe9bi5LP3xu3PAdTQVdI"
}
```
...
|cpln-user                  |cpln-user                                |9 months ago  |default |sOajhentlsc226k8 |              |
|demo-service-account       |demo-service-account                     |6 minutes ago |default |sGGobUDp52IFGKzE |drink="water" |
...
```bash Command
cpln serviceaccount remove-key demo-service-account --key szO1BVUCpngoVTUs --org demo-cpln-organization
```
...
|rMdL2BFDxEeYQPA5qRYGbLivhVS2 |Kyle Cupp            |kyle@controlplane.com |4 months ago |firebase |firebase/sign_in_provider="microsoft.com" |
+-----------------------------+---------------------+----------------------+-------------+---------+------------------------------------------+
```
...
|NAME                |DESCRIPTION            |GVC               |READY     |CREATED       |ENDPOINT                                             |TAGS          |
|--------------------|-----------------------|------------------|----------|--------------|-----------------------------------------------------|--------------|
|demo-workload-clone |Clone of demo-workload |demo-gvc-workload |          |0 minutes ago |https://demo-workload-clone-y2bm6g4fkqt8w.t.cpln.app |drink="water" |
+--------------------+-----------------------+------------------+----------+--------------+-----------------------------------------------------+--------------+
```
...
|NAME          |DESCRIPTION   |GVC               |READY     |CREATED       |ENDPOINT                                       |TAGS          |
|--------------|--------------|------------------|----------|--------------|-----------------------------------------------|--------------|
|demo-workload |demo-workload |demo-gvc-workload |          |0 minutes ago |https://demo-workload-y2bm6g4fkqt8w.t.cpln.app |drink="water" |
+--------------+--------------+------------------+----------+--------------+-----------------------------------------------+--------------+
```
...
|NAME                |DESCRIPTION         |GVC               |READY |CREATED       |ENDPOINT                                             |TAGS          |
|--------------------|--------------------|------------------|------|--------------|-----------------------------------------------------|--------------|
|demo-workload-get-2 |demo-workload-get-2 |demo-gvc-workload |false |0 minutes ago |https://demo-workload-get-2-y2bm6g4fkqt8w.t.cpln.app |              |
|demo-workload-get-1 |demo-workload-get-1 |demo-gvc-workload |false |0 minutes ago |https://demo-workload-get-1-y2bm6g4fkqt8w.t.cpln.app |              |
|demo-workload       |demo-workload       |demo-gvc-workload |true  |7 minutes ago |https://demo-workload-y2bm6g4fkqt8w.t.cpln.app       |drink="water" |
+--------------------+--------------------+------------------+------+--------------+-----------------------------------------------------+--------------+
```
...
|NAME                |DESCRIPTION         |GVC               |READY     |CREATED       |ENDPOINT                                             |TAGS          |
|--------------------|--------------------|------------------|----------|--------------|-----------------------------------------------------|--------------|
|demo-workload-get-2 |demo-workload-get-2 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-get-2-y2bm6g4fkqt8w.t.cpln.app |              |
|demo-workload-get-1 |demo-workload-get-1 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-get-1-y2bm6g4fkqt8w.t.cpln.app |              |
|demo-workload       |demo-workload       |demo-gvc-workload |          |7 minutes ago |https://demo-workload-y2bm6g4fkqt8w.t.cpln.app       |drink="water" |
+--------------------+--------------------+------------------+----------+--------------+-----------------------------------------------------+--------------+
```
...
|NAME                |DESCRIPTION         |GVC               |READY     |CREATED       |ENDPOINT                                             |TAGS          |
|--------------------|--------------------|------------------|----------|--------------|-----------------------------------------------------|--------------|
|demo-workload-tag-1 |demo-workload-tag-1 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-1-y2bm6g4fkqt8w.t.cpln.app |drink="water" |
+--------------------+--------------------+------------------+----------+--------------+-----------------------------------------------------+--------------+
```
...
|NAME                |DESCRIPTION         |GVC               |READY     |CREATED       |ENDPOINT                                             |TAGS           |
|--------------------|--------------------|------------------|----------|--------------|-----------------------------------------------------|---------------|
|demo-workload-tag-1 |demo-workload-tag-1 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-1-y2bm6g4fkqt8w.t.cpln.app |drink="coffee" |
+--------------------+--------------------+------------------+----------+--------------+-----------------------------------------------------+---------------+
```
...
|NAME                |DESCRIPTION         |GVC               |READY     |CREATED       |ENDPOINT                                             |TAGS |
|--------------------|--------------------|------------------|----------|--------------|-----------------------------------------------------|-----|
|demo-workload-tag-1 |demo-workload-tag-1 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-1-y2bm6g4fkqt8w.t.cpln.app |     |
+--------------------+--------------------+------------------+----------+--------------+-----------------------------------------------------+-----+
```
...
|NAME                |DESCRIPTION         |GVC               |READY     |CREATED       |ENDPOINT                                             |TAGS                      |
|--------------------|--------------------|------------------|----------|--------------|-----------------------------------------------------|--------------------------|
|demo-workload-tag-1 |demo-workload-tag-1 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-1-y2bm6g4fkqt8w.t.cpln.app |multiple-workloads="true" |
|demo-workload-tag-2 |demo-workload-tag-2 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-2-y2bm6g4fkqt8w.t.cpln.app |multiple-workloads="true" |
+--------------------+--------------------+------------------+----------+--------------+-----------------------------------------------------+--------------------------+
```
...
|NAME                |DESCRIPTION         |GVC               |READY     |CREATED       |ENDPOINT                                             |TAGS                               |
|--------------------|--------------------|------------------|----------|--------------|-----------------------------------------------------|-----------------------------------|
|demo-workload-tag-1 |demo-workload-tag-1 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-1-y2bm6g4fkqt8w.t.cpln.app |multiple-workloads="demo-workload" |
|demo-workload-tag-2 |demo-workload-tag-2 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-2-y2bm6g4fkqt8w.t.cpln.app |multiple-workloads="demo-workload" |
+--------------------+--------------------+------------------+----------+--------------+-----------------------------------------------------+-----------------------------------+
```
...
|--------------------|--------------------|------------------|----------|--------------|-----------------------------------------------------|-----|
|demo-workload-tag-1 |demo-workload-tag-1 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-1-y2bm6g4fkqt8w.t.cpln.app |     |
|demo-workload-tag-2 |demo-workload-tag-2 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-2-y2bm6g4fkqt8w.t.cpln.app |     |
+--------------------+--------------------+------------------+----------+--------------+-----------------------------------------------------+-----+
```
...
|NAME                 |DESCRIPTION          |GVC               |READY     |CREATED       |ENDPOINT                                              |TAGS |
|---------------------|---------------------|------------------|----------|--------------|------------------------------------------------------|-----|
|demo-workload-update |demo-workload-update |demo-gvc-workload |          |0 minutes ago |https://demo-workload-update-y2bm6g4fkqt8w.t.cpln.app |     |
+---------------------+---------------------+------------------+----------+--------------+------------------------------------------------------+-----+
```
...
|NAME                 |DESCRIPTION     |GVC               |READY     |CREATED       |ENDPOINT                                              |TAGS |
|---------------------|----------------|------------------|----------|--------------|------------------------------------------------------|-----|
|demo-workload-update |new description |demo-gvc-workload |          |0 minutes ago |https://demo-workload-update-y2bm6g4fkqt8w.t.cpln.app |     |
+---------------------+----------------+------------------+----------+--------------+------------------------------------------------------+-----+
```
...
|NAME                 |DESCRIPTION     |GVC               |READY     |CREATED       |ENDPOINT                                              |TAGS                  |
|---------------------|----------------|------------------|----------|--------------|------------------------------------------------------|----------------------|
|demo-workload-update |new description |demo-gvc-workload |          |0 minutes ago |https://demo-workload-update-y2bm6g4fkqt8w.t.cpln.app |demo-key="demo-value" |
+---------------------+----------------+------------------+----------+--------------+------------------------------------------------------+----------------------+
```
