...
[macOS-arm64](https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/1608230269-7c7c2241/cpln-macos-arm64.dmg)

[macOS-x64](https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/1608230269-7c7c2241/cpln-macos-x64.dmg)

[Linux](https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/1608230269-7c7c2241/cpln-linux.tgz)

[Windows](https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/1608230269-7c7c2241/cpln-win.zip)

<Accordion title="View Checksum">

| OS            | File                 | sha256               |
| ------------- | -------------------- | -------------------- |
| macOS-arm64   | cpln-macos-arm64.dmg | 7641e4f92a6426826e27fca376fd2c4fa4de89c37d72ef05e4a7a984659a1652 |
| macOS-x64     | cpln-macos-x64.dmg   | 1c4cb57fd0c4d4521d5d81c22d6c925d22f9188a1eeadf857abf322985c9a433   |
| Linux         | cpln-linux.tgz       | 08dd5df8d4707c087a8ffddad919d1b03353b70e50c7f2ec4b93441044f076c8       |
| Windows 10/11 | cpln-win.zip         | 81f749830c466749d8aeb523755a23246e40dff331c27eef0f12fa87772583b6     |
...
```text Output
{
  "agentId": "241c5a38-eea6-4fb6-852b-d83e403f788e",
  "agentLink": "/org/demo-cpln-organization/agent/demo-agent",
  "hubEndpoint": "https://hub.test.cpln.io",
  "registrationToken": "a2zqYmL4GS0gB19iNO4IqnM8QyfWbj0SgLRwmgkZ9SJrVxKRp-7W77mQ/FQ1yVX"
}
```
...
|---------|------------|--------------|--------------|----------|-----------------|--------------|
|demo-gvc |demo-gvc    |2 minutes ago |82q01ry50zcfr |          |aws-eu-central-1 |drink="water" |
|         |            |              |              |          |aws-us-west-2    |              |
+---------+------------+--------------+--------------+----------+-----------------+--------------+
```
...
|NAME           |DESCRIPTION       |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS          |
|---------------|------------------|--------------|--------------|----------|-----------------|--------------|
|demo-gvc-clone |Clone of demo-gvc |0 minutes ago |ncczq5tax8b7m |          |aws-eu-central-1 |drink="water" |
|               |                  |              |              |          |aws-us-west-2    |              |
|               |                  |              |              |          |gcp-us-east1     |              |
+---------------+------------------+--------------+--------------+----------+-----------------+--------------+
```
...
|NAME     |DESCRIPTION |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS          |
|---------|------------|--------------|--------------|----------|-----------------|--------------|
|demo-gvc |demo-gvc    |0 minutes ago |82q01ry50zcfr |          |aws-eu-central-1 |drink="water" |
+---------+------------+--------------+--------------+----------+-----------------+--------------+
```
...
|------------|------------|------------------------|----------|--------------|---------------------------------------------|-----|
|workload-01 |workload-01 |demo-gvc-with-workloads |          |0 minutes ago |https://workload-01-yg3e1vedcaghy.t.cpln.app |     |
|workload-02 |workload-02 |demo-gvc-with-workloads |          |0 minutes ago |https://workload-02-yg3e1vedcaghy.t.cpln.app |     |
+------------+------------+------------------------+----------+--------------+---------------------------------------------+-----+
```
...
|                        |                        |              |              |          |aws-us-west-2    |              |
|                        |                        |              |              |          |gcp-us-east1     |              |
|demo-gvc-get-1          |demo-gvc-get-1          |0 minutes ago |3tz39rc7adnya |          |aws-eu-central-1 |              |
|demo-gvc-get-2          |demo-gvc-get-2          |0 minutes ago |t9trbv4phmm9g |          |aws-eu-central-1 |              |
|demo-gvc-identity       |demo-gvc-identity       |2 minutes ago |m80r9x6wace8y |          |aws-eu-central-1 |              |
|demo-gvc-with-workloads |demo-gvc-with-workloads |0 minutes ago |yg3e1vedcaghy |          |aws-eu-central-1 |              |
|demo-gvc-workload       |demo-gvc-workload       |2 minutes ago |t7jakkw2sxb48 |          |aws-eu-central-1 |              |
+------------------------+------------------------+--------------+--------------+----------+-----------------+--------------+
```
...
|NAME                    |DESCRIPTION             |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS |
|------------------------|------------------------|--------------|--------------|----------|-----------------|-----|
|demo-gvc-with-locations |demo-gvc-with-locations |0 minutes ago |z3cgpc2n4cmaw |          |aws-eu-central-1 |     |
|                        |                        |              |              |          |aws-us-west-2    |     |
|                        |                        |              |              |          |gcp-us-east1     |     |
+------------------------+------------------------+--------------+--------------+----------+-----------------+-----+
```
...
|NAME                    |DESCRIPTION             |CREATED       |ALIAS         |DOMAIN    |LOCATIONS    |TAGS |
|------------------------|------------------------|--------------|--------------|----------|-------------|-----|
|demo-gvc-with-locations |demo-gvc-with-locations |0 minutes ago |z3cgpc2n4cmaw |          |gcp-us-east1 |     |
+------------------------+------------------------+--------------+--------------+----------+-------------+-----+
```
...
|NAME           |DESCRIPTION    |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS          |
|---------------|---------------|--------------|--------------|----------|-----------------|--------------|
|demo-gvc-tag-1 |demo-gvc-tag-1 |0 minutes ago |mkdcz4b0kedqa |          |aws-eu-central-1 |drink="water" |
+---------------+---------------+--------------+--------------+----------+-----------------+--------------+
```
...
|NAME           |DESCRIPTION    |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS           |
|---------------|---------------|--------------|--------------|----------|-----------------|---------------|
|demo-gvc-tag-1 |demo-gvc-tag-1 |0 minutes ago |mkdcz4b0kedqa |          |aws-eu-central-1 |drink="coffee" |
+---------------+---------------+--------------+--------------+----------+-----------------+---------------+
```
...
|NAME           |DESCRIPTION    |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS |
|---------------|---------------|--------------|--------------|----------|-----------------|-----|
|demo-gvc-tag-1 |demo-gvc-tag-1 |0 minutes ago |mkdcz4b0kedqa |          |aws-eu-central-1 |     |
+---------------+---------------+--------------+--------------+----------+-----------------+-----+
```
...
|NAME           |DESCRIPTION    |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS                 |
|---------------|---------------|--------------|--------------|----------|-----------------|---------------------|
|demo-gvc-tag-1 |demo-gvc-tag-1 |0 minutes ago |mkdcz4b0kedqa |          |aws-eu-central-1 |multiple-gvcs="true" |
|demo-gvc-tag-2 |demo-gvc-tag-2 |0 minutes ago |vckfn1sgczrcr |          |aws-eu-central-1 |multiple-gvcs="true" |
+---------------+---------------+--------------+--------------+----------+-----------------+---------------------+
```
...
|NAME           |DESCRIPTION    |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS                     |
|---------------|---------------|--------------|--------------|----------|-----------------|-------------------------|
|demo-gvc-tag-1 |demo-gvc-tag-1 |0 minutes ago |mkdcz4b0kedqa |          |aws-eu-central-1 |multiple-gvcs="demo-gvc" |
|demo-gvc-tag-2 |demo-gvc-tag-2 |0 minutes ago |vckfn1sgczrcr |          |aws-eu-central-1 |multiple-gvcs="demo-gvc" |
+---------------+---------------+--------------+--------------+----------+-----------------+-------------------------+
```
...
|---------------|---------------|--------------|--------------|----------|-----------------|-----|
|demo-gvc-tag-1 |demo-gvc-tag-1 |0 minutes ago |mkdcz4b0kedqa |          |aws-eu-central-1 |     |
|demo-gvc-tag-2 |demo-gvc-tag-2 |0 minutes ago |vckfn1sgczrcr |          |aws-eu-central-1 |     |
+---------------+---------------+--------------+--------------+----------+-----------------+-----+
```
...
|NAME            |DESCRIPTION     |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS |
|----------------|----------------|--------------|--------------|----------|-----------------|-----|
|demo-gvc-update |demo-gvc-update |0 minutes ago |b845v17fx726y |          |aws-eu-central-1 |     |
+----------------+----------------+--------------+--------------+----------+-----------------+-----+
```
...
|NAME            |DESCRIPTION     |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS |
|----------------|----------------|--------------|--------------|----------|-----------------|-----|
|demo-gvc-update |new description |0 minutes ago |b845v17fx726y |          |aws-eu-central-1 |     |
+----------------+----------------+--------------+--------------+----------+-----------------+-----+
```
...
|NAME            |DESCRIPTION     |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS                  |
|----------------|----------------|--------------|--------------|----------|-----------------|----------------------|
|demo-gvc-update |new description |0 minutes ago |b845v17fx726y |          |aws-eu-central-1 |demo-key="demo-value" |
+----------------+----------------+--------------+--------------+----------+-----------------+----------------------+
```
...
|--------------|--------------|------------------|-------------------------------|--------------|----------|--------------|
|demo-identity |demo-identity |demo-gvc-identity |cpln-demo-cpln-organi-xzz8mrpa |0 minutes ago |          |drink="water" |
+--------------+--------------+------------------+-------------------------------+--------------+----------+--------------+
```
...
|NAME                |DESCRIPTION         |GVC               |LOCAL NAME                     |CREATED       |PROVIDERS |TAGS          |
|--------------------|--------------------|------------------|-------------------------------|--------------|----------|--------------|
|demo-identity-get-2 |demo-identity-get-2 |demo-gvc-identity |cpln-demo-cpln-organi-cwgk0m3d |0 minutes ago |          |              |
|demo-identity       |demo-identity       |demo-gvc-identity |cpln-demo-cpln-organi-xzz8mrpa |3 minutes ago |          |drink="water" |
|demo-identity-get-1 |demo-identity-get-1 |demo-gvc-identity |cpln-demo-cpln-organi-5e3tyz8x |0 minutes ago |          |              |
+--------------------+--------------------+------------------+-------------------------------+--------------+----------+--------------+
```
...
|NAME          |DESCRIPTION   |GVC               |LOCAL NAME                     |CREATED       |PROVIDERS |TAGS           |
|--------------|--------------|------------------|-------------------------------|--------------|----------|---------------|
|demo-identity |demo-identity |demo-gvc-identity |cpln-demo-cpln-organi-xzz8mrpa |3 minutes ago |          |drink="coffee" |
+--------------+--------------+------------------+-------------------------------+--------------+----------+---------------+
```
...
|NAME          |DESCRIPTION   |GVC               |LOCAL NAME                     |CREATED       |PROVIDERS |TAGS |
|--------------|--------------|------------------|-------------------------------|--------------|----------|-----|
|demo-identity |demo-identity |demo-gvc-identity |cpln-demo-cpln-organi-xzz8mrpa |3 minutes ago |          |     |
+--------------+--------------+------------------+-------------------------------+--------------+----------+-----+
```
...
|NAME                 |DESCRIPTION          |GVC               |LOCAL NAME                     |CREATED       |PROVIDERS |TAGS |
|---------------------|---------------------|------------------|-------------------------------|--------------|----------|-----|
|demo-identity-update |demo-identity-update |demo-gvc-identity |cpln-demo-cpln-organi-4m50crw7 |0 minutes ago |          |     |
+---------------------+---------------------+------------------+-------------------------------+--------------+----------+-----+
```
...
|NAME                 |DESCRIPTION     |GVC               |LOCAL NAME                     |CREATED       |PROVIDERS |TAGS |
|---------------------|----------------|------------------|-------------------------------|--------------|----------|-----|
|demo-identity-update |new description |demo-gvc-identity |cpln-demo-cpln-organi-4m50crw7 |0 minutes ago |          |     |
+---------------------+----------------+------------------+-------------------------------+--------------+----------+-----+
```
...
|NAME                 |DESCRIPTION     |GVC               |LOCAL NAME                     |CREATED       |PROVIDERS |TAGS                  |
|---------------------|----------------|------------------|-------------------------------|--------------|----------|----------------------|
|demo-identity-update |new description |demo-gvc-identity |cpln-demo-cpln-organi-4m50crw7 |0 minutes ago |          |demo-key="demo-value" |
+---------------------+----------------+------------------+-------------------------------+--------------+----------+----------------------+
```
...
|superusers-ipset           |Built-in policy granting full access ... |2 months ago  |ipset           |all     |builtin |              |
...
|viewers-ipset              |Built-in policy granting read-only ac... |2 months ago  |ipset           |all     |builtin |              |
...
|615e3e1b-c1a5-4144-be3c-8df1e60b7576 |workloads-per-gvc     |Max number of workloads in a gvc         |builtin |1       |20   |count     |gvcLink="demo-gvc-workload"       |
...
|8bc92059-e941-4866-9631-93794d41aa63 |workloads-per-gvc     |Max number of workloads in a gvc         |builtin |0       |20   |count     |gvcLink="demo-gvc-with-workloads" |
|8c44149c-9194-4e76-8c3b-77a2acfa3345 |identities-per-gvc    |Max number of workload identities in ... |builtin |4       |20   |count     |gvcLink="demo-gvc-identity"       |
...
```text Output
{
  ...
  "created": "2025-01-03T17:34:01.435Z",
  "key": "sTiPBsjXPRT079wU.ZGVtby1jcGxuLW9yZ2FuaXphdGlvbi5kZW1vLXNlcnZpY2UtYWNjb3VudC4zWmF6ekc2WDZza1NHL0ZHTkkvWlZrZW1Lb0Z1MGJkQ09vaXlhUHpvMGFBPQ.66oIcknxdNPrSuPiUktNSvBCoExrbBhdykKrqVohy_w"
}
```
...
|demo-service-account       |demo-service-account                     |6 minutes ago |default |sTiPBsjXPRT079wU |drink="water" |
...
```bash Command
cpln serviceaccount remove-key demo-service-account --key sFfdgzrGlqN86LAQ --org demo-cpln-organization
```
...
|-----------------------------|---------------------|----------------------|-------------|---------|------------------------------------------|
|rMdL2BFDxEeYQPA5qRYGbLivhVS2 |Kyle Cupp            |kyle@controlplane.com |9 months ago |firebase |firebase/sign_in_provider="microsoft.com" |
...
|NAME                |DESCRIPTION            |GVC               |READY     |CREATED       |ENDPOINT                                             |TAGS          |
|--------------------|-----------------------|------------------|----------|--------------|-----------------------------------------------------|--------------|
|demo-workload-clone |Clone of demo-workload |demo-gvc-workload |          |0 minutes ago |https://demo-workload-clone-t7jakkw2sxb48.t.cpln.app |drink="water" |
+--------------------+-----------------------+------------------+----------+--------------+-----------------------------------------------------+--------------+
```
...
|NAME          |DESCRIPTION   |GVC               |READY     |CREATED       |ENDPOINT                                       |TAGS          |
|--------------|--------------|------------------|----------|--------------|-----------------------------------------------|--------------|
|demo-workload |demo-workload |demo-gvc-workload |          |0 minutes ago |https://demo-workload-t7jakkw2sxb48.t.cpln.app |drink="water" |
+--------------+--------------+------------------+----------+--------------+-----------------------------------------------+--------------+
```
...
|NAME                |DESCRIPTION         |GVC               |READY |CREATED       |ENDPOINT                                             |TAGS          |
|--------------------|--------------------|------------------|------|--------------|-----------------------------------------------------|--------------|
|demo-workload-get-2 |demo-workload-get-2 |demo-gvc-workload |false |0 minutes ago |https://demo-workload-get-2-t7jakkw2sxb48.t.cpln.app |              |
|demo-workload-get-1 |demo-workload-get-1 |demo-gvc-workload |false |0 minutes ago |https://demo-workload-get-1-t7jakkw2sxb48.t.cpln.app |              |
|demo-workload       |demo-workload       |demo-gvc-workload |true  |7 minutes ago |https://demo-workload-t7jakkw2sxb48.t.cpln.app       |drink="water" |
+--------------------+--------------------+------------------+------+--------------+-----------------------------------------------------+--------------+
```
...
|NAME                |DESCRIPTION         |GVC               |READY     |CREATED       |ENDPOINT                                             |TAGS          |
|--------------------|--------------------|------------------|----------|--------------|-----------------------------------------------------|--------------|
|demo-workload-get-2 |demo-workload-get-2 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-get-2-t7jakkw2sxb48.t.cpln.app |              |
|demo-workload-get-1 |demo-workload-get-1 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-get-1-t7jakkw2sxb48.t.cpln.app |              |
|demo-workload       |demo-workload       |demo-gvc-workload |          |7 minutes ago |https://demo-workload-t7jakkw2sxb48.t.cpln.app       |drink="water" |
+--------------------+--------------------+------------------+----------+--------------+-----------------------------------------------------+--------------+
```
...
|NAME                |DESCRIPTION         |GVC               |READY     |CREATED       |ENDPOINT                                             |TAGS          |
|--------------------|--------------------|------------------|----------|--------------|-----------------------------------------------------|--------------|
|demo-workload-tag-1 |demo-workload-tag-1 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-1-t7jakkw2sxb48.t.cpln.app |drink="water" |
+--------------------+--------------------+------------------+----------+--------------+-----------------------------------------------------+--------------+
```
...
|NAME                |DESCRIPTION         |GVC               |READY     |CREATED       |ENDPOINT                                             |TAGS           |
|--------------------|--------------------|------------------|----------|--------------|-----------------------------------------------------|---------------|
|demo-workload-tag-1 |demo-workload-tag-1 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-1-t7jakkw2sxb48.t.cpln.app |drink="coffee" |
+--------------------+--------------------+------------------+----------+--------------+-----------------------------------------------------+---------------+
```
...
|NAME                |DESCRIPTION         |GVC               |READY     |CREATED       |ENDPOINT                                             |TAGS |
|--------------------|--------------------|------------------|----------|--------------|-----------------------------------------------------|-----|
|demo-workload-tag-1 |demo-workload-tag-1 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-1-t7jakkw2sxb48.t.cpln.app |     |
+--------------------+--------------------+------------------+----------+--------------+-----------------------------------------------------+-----+
```
...
|NAME                |DESCRIPTION         |GVC               |READY     |CREATED       |ENDPOINT                                             |TAGS                      |
|--------------------|--------------------|------------------|----------|--------------|-----------------------------------------------------|--------------------------|
|demo-workload-tag-1 |demo-workload-tag-1 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-1-t7jakkw2sxb48.t.cpln.app |multiple-workloads="true" |
|demo-workload-tag-2 |demo-workload-tag-2 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-2-t7jakkw2sxb48.t.cpln.app |multiple-workloads="true" |
+--------------------+--------------------+------------------+----------+--------------+-----------------------------------------------------+--------------------------+
```
...
|NAME                |DESCRIPTION         |GVC               |READY     |CREATED       |ENDPOINT                                             |TAGS                               |
|--------------------|--------------------|------------------|----------|--------------|-----------------------------------------------------|-----------------------------------|
|demo-workload-tag-1 |demo-workload-tag-1 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-1-t7jakkw2sxb48.t.cpln.app |multiple-workloads="demo-workload" |
|demo-workload-tag-2 |demo-workload-tag-2 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-2-t7jakkw2sxb48.t.cpln.app |multiple-workloads="demo-workload" |
+--------------------+--------------------+------------------+----------+--------------+-----------------------------------------------------+-----------------------------------+
```
...
|--------------------|--------------------|------------------|----------|--------------|-----------------------------------------------------|-----|
|demo-workload-tag-1 |demo-workload-tag-1 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-1-t7jakkw2sxb48.t.cpln.app |     |
|demo-workload-tag-2 |demo-workload-tag-2 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-2-t7jakkw2sxb48.t.cpln.app |     |
+--------------------+--------------------+------------------+----------+--------------+-----------------------------------------------------+-----+
```
...
|NAME                 |DESCRIPTION          |GVC               |READY     |CREATED       |ENDPOINT                                              |TAGS |
|---------------------|---------------------|------------------|----------|--------------|------------------------------------------------------|-----|
|demo-workload-update |demo-workload-update |demo-gvc-workload |          |0 minutes ago |https://demo-workload-update-t7jakkw2sxb48.t.cpln.app |     |
+---------------------+---------------------+------------------+----------+--------------+------------------------------------------------------+-----+
```
...
|NAME                 |DESCRIPTION     |GVC               |READY     |CREATED       |ENDPOINT                                              |TAGS |
|---------------------|----------------|------------------|----------|--------------|------------------------------------------------------|-----|
|demo-workload-update |new description |demo-gvc-workload |          |0 minutes ago |https://demo-workload-update-t7jakkw2sxb48.t.cpln.app |     |
+---------------------+----------------+------------------+----------+--------------+------------------------------------------------------+-----+
```
...
|NAME                 |DESCRIPTION     |GVC               |READY     |CREATED       |ENDPOINT                                              |TAGS                  |
|---------------------|----------------|------------------|----------|--------------|------------------------------------------------------|----------------------|
|demo-workload-update |new description |demo-gvc-workload |          |0 minutes ago |https://demo-workload-update-t7jakkw2sxb48.t.cpln.app |demo-key="demo-value" |
+---------------------+----------------+------------------+----------+--------------+------------------------------------------------------+----------------------+
```
