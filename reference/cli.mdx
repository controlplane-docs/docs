...
[macOS-arm64](https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/1833062445-b49c2289/cpln-macos-arm64.dmg)

[macOS-x64](https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/1833062445-b49c2289/cpln-macos-x64.dmg)

[Linux](https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/1833062445-b49c2289/cpln-linux.tgz)

[Windows](https://storage.googleapis.com/artifacts.cpln-build.appspot.com/binaries/cpln/1833062445-b49c2289/cpln-win.zip)

<Accordion title="View Checksum">

| OS            | File                 | sha256               |
| ------------- | -------------------- | -------------------- |
| macOS-arm64   | cpln-macos-arm64.dmg | 02d1f8def9299d294ac6ef05a1e1287936429bb45f056df899b993382da6c23b |
| macOS-x64     | cpln-macos-x64.dmg   | 2cfdf9b6d81d8fe6eb44ea4c94b55cf734f3071254840e436027ea8be1007f63   |
| Linux         | cpln-linux.tgz       | 1f82ebfa8aac268f75b36e1f5e1e26cdf1e232f317e1c3a9e05e512a3bb51da0       |
| Windows 10/11 | cpln-win.zip         | bb52eaa44d13f29bd18083712be0cf90ff82e74c9937c7f53d45d3a410589a55     |
...
```text Output
{
  "agentId": "f341055e-7359-4159-abbb-056b038c685c",
  "agentLink": "/org/demo-cpln-organization/agent/demo-agent",
  "hubEndpoint": "https://hub.test.cpln.io",
  "registrationToken": "a2JlxrYS6lD6tSsRrOaDMqIo4GHhgMRLhZffFEAX6_nH-txln_KXx5Tw/ZtIl6S"
}
```
...
|---------|------------|--------------|--------------|----------|-----------------|--------------|
|demo-gvc |demo-gvc    |3 minutes ago |mgm6twwq8aane |          |aws-eu-central-1 |drink="water" |
|         |            |              |              |          |aws-us-west-2    |              |
+---------+------------+--------------+--------------+----------+-----------------+--------------+
```
...
|NAME           |DESCRIPTION       |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS          |
|---------------|------------------|--------------|--------------|----------|-----------------|--------------|
|demo-gvc-clone |Clone of demo-gvc |0 minutes ago |61c7sjy09eg9j |          |aws-eu-central-1 |drink="water" |
|               |                  |              |              |          |aws-us-west-2    |              |
|               |                  |              |              |          |gcp-us-east1     |              |
+---------------+------------------+--------------+--------------+----------+-----------------+--------------+
```
...
|NAME     |DESCRIPTION |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS          |
|---------|------------|--------------|--------------|----------|-----------------|--------------|
|demo-gvc |demo-gvc    |0 minutes ago |mgm6twwq8aane |          |aws-eu-central-1 |drink="water" |
+---------+------------+--------------+--------------+----------+-----------------+--------------+
```
...
|------------|------------|------------------------|----------|--------------|---------------------------------------------|-----|
|workload-01 |workload-01 |demo-gvc-with-workloads |          |0 minutes ago |https://workload-01-fw4gsmpgfvp66.t.cpln.app |     |
|workload-02 |workload-02 |demo-gvc-with-workloads |          |0 minutes ago |https://workload-02-fw4gsmpgfvp66.t.cpln.app |     |
+------------+------------+------------------------+----------+--------------+---------------------------------------------+-----+
```
...
|                        |                        |              |              |          |aws-us-west-2    |              |
|                        |                        |              |              |          |gcp-us-east1     |              |
|demo-gvc-get-1          |demo-gvc-get-1          |0 minutes ago |m404gw17g51qa |          |aws-eu-central-1 |              |
|demo-gvc-get-2          |demo-gvc-get-2          |0 minutes ago |fn1f0j4yzns1e |          |aws-eu-central-1 |              |
|demo-gvc-identity       |demo-gvc-identity       |3 minutes ago |924hfvdaygfz2 |          |aws-eu-central-1 |              |
|demo-gvc-with-workloads |demo-gvc-with-workloads |0 minutes ago |fw4gsmpgfvp66 |          |aws-eu-central-1 |              |
|demo-gvc-workload       |demo-gvc-workload       |4 minutes ago |wv64zc0za55qw |          |aws-eu-central-1 |              |
+------------------------+------------------------+--------------+--------------+----------+-----------------+--------------+
```
...
|NAME     |DESCRIPTION |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS          |
|---------|------------|--------------|--------------|----------|-----------------|--------------|
|demo-gvc |demo-gvc    |4 minutes ago |mgm6twwq8aane |          |aws-eu-central-1 |drink="water" |
|         |            |              |              |          |aws-us-west-2    |              |
|         |            |              |              |          |gcp-us-east1     |              |
+---------+------------+--------------+--------------+----------+-----------------+--------------+
```
...
|NAME                    |DESCRIPTION             |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS |
|------------------------|------------------------|--------------|--------------|----------|-----------------|-----|
|demo-gvc-with-locations |demo-gvc-with-locations |0 minutes ago |6zdtxyd97zx0y |          |aws-eu-central-1 |     |
|                        |                        |              |              |          |aws-us-west-2    |     |
|                        |                        |              |              |          |gcp-us-east1     |     |
+------------------------+------------------------+--------------+--------------+----------+-----------------+-----+
```
...
|NAME                    |DESCRIPTION             |CREATED       |ALIAS         |DOMAIN    |LOCATIONS    |TAGS |
|------------------------|------------------------|--------------|--------------|----------|-------------|-----|
|demo-gvc-with-locations |demo-gvc-with-locations |0 minutes ago |6zdtxyd97zx0y |          |gcp-us-east1 |     |
+------------------------+------------------------+--------------+--------------+----------+-------------+-----+
```
...
|NAME           |DESCRIPTION    |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS          |
|---------------|---------------|--------------|--------------|----------|-----------------|--------------|
|demo-gvc-tag-1 |demo-gvc-tag-1 |0 minutes ago |5y998b4r95asp |          |aws-eu-central-1 |drink="water" |
+---------------+---------------+--------------+--------------+----------+-----------------+--------------+
```
...
|NAME           |DESCRIPTION    |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS           |
|---------------|---------------|--------------|--------------|----------|-----------------|---------------|
|demo-gvc-tag-1 |demo-gvc-tag-1 |0 minutes ago |5y998b4r95asp |          |aws-eu-central-1 |drink="coffee" |
+---------------+---------------+--------------+--------------+----------+-----------------+---------------+
```
...
|NAME           |DESCRIPTION    |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS |
|---------------|---------------|--------------|--------------|----------|-----------------|-----|
|demo-gvc-tag-1 |demo-gvc-tag-1 |0 minutes ago |5y998b4r95asp |          |aws-eu-central-1 |     |
+---------------+---------------+--------------+--------------+----------+-----------------+-----+
```
...
|NAME           |DESCRIPTION    |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS                 |
|---------------|---------------|--------------|--------------|----------|-----------------|---------------------|
|demo-gvc-tag-1 |demo-gvc-tag-1 |0 minutes ago |5y998b4r95asp |          |aws-eu-central-1 |multiple-gvcs="true" |
|demo-gvc-tag-2 |demo-gvc-tag-2 |0 minutes ago |0ks4gtkxqfd2e |          |aws-eu-central-1 |multiple-gvcs="true" |
+---------------+---------------+--------------+--------------+----------+-----------------+---------------------+
```
...
|NAME           |DESCRIPTION    |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS                     |
|---------------|---------------|--------------|--------------|----------|-----------------|-------------------------|
|demo-gvc-tag-1 |demo-gvc-tag-1 |0 minutes ago |5y998b4r95asp |          |aws-eu-central-1 |multiple-gvcs="demo-gvc" |
|demo-gvc-tag-2 |demo-gvc-tag-2 |0 minutes ago |0ks4gtkxqfd2e |          |aws-eu-central-1 |multiple-gvcs="demo-gvc" |
+---------------+---------------+--------------+--------------+----------+-----------------+-------------------------+
```
...
|---------------|---------------|--------------|--------------|----------|-----------------|-----|
|demo-gvc-tag-1 |demo-gvc-tag-1 |0 minutes ago |5y998b4r95asp |          |aws-eu-central-1 |     |
|demo-gvc-tag-2 |demo-gvc-tag-2 |0 minutes ago |0ks4gtkxqfd2e |          |aws-eu-central-1 |     |
+---------------+---------------+--------------+--------------+----------+-----------------+-----+
```
...
|NAME            |DESCRIPTION     |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS |
|----------------|----------------|--------------|--------------|----------|-----------------|-----|
|demo-gvc-update |demo-gvc-update |0 minutes ago |bn8g6ga4d0gcy |          |aws-eu-central-1 |     |
+----------------+----------------+--------------+--------------+----------+-----------------+-----+
```
...
|NAME            |DESCRIPTION     |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS |
|----------------|----------------|--------------|--------------|----------|-----------------|-----|
|demo-gvc-update |new description |0 minutes ago |bn8g6ga4d0gcy |          |aws-eu-central-1 |     |
+----------------+----------------+--------------+--------------+----------+-----------------+-----+
```
...
|NAME            |DESCRIPTION     |CREATED       |ALIAS         |DOMAIN    |LOCATIONS        |TAGS                  |
|----------------|----------------|--------------|--------------|----------|-----------------|----------------------|
|demo-gvc-update |new description |0 minutes ago |bn8g6ga4d0gcy |          |aws-eu-central-1 |demo-key="demo-value" |
+----------------+----------------+--------------+--------------+----------+-----------------+----------------------+
```
...
|--------------|--------------|------------------|-------------------------------|--------------|----------|--------------|
|demo-identity |demo-identity |demo-gvc-identity |cpln-demo-cpln-organi-42yth1jf |0 minutes ago |          |drink="water" |
+--------------+--------------+------------------+-------------------------------+--------------+----------+--------------+
```
...
|NAME                |DESCRIPTION         |GVC               |LOCAL NAME                     |CREATED       |PROVIDERS |TAGS          |
|--------------------|--------------------|------------------|-------------------------------|--------------|----------|--------------|
|demo-identity-get-2 |demo-identity-get-2 |demo-gvc-identity |cpln-demo-cpln-organi-s654pgev |0 minutes ago |          |              |
|demo-identity       |demo-identity       |demo-gvc-identity |cpln-demo-cpln-organi-42yth1jf |4 minutes ago |          |drink="water" |
|demo-identity-get-1 |demo-identity-get-1 |demo-gvc-identity |cpln-demo-cpln-organi-58qrarzx |0 minutes ago |          |              |
+--------------------+--------------------+------------------+-------------------------------+--------------+----------+--------------+
```
...
|--------------------|--------------------|------------------|-------------------------------|--------------|----------|--------------|
|demo-identity-get-2 |demo-identity-get-2 |demo-gvc-identity |cpln-demo-cpln-organi-s654pgev |0 minutes ago |          |              |
|demo-identity       |demo-identity       |demo-gvc-identity |cpln-demo-cpln-organi-42yth1jf |5 minutes ago |          |drink="water" |
|demo-identity-get-1 |demo-identity-get-1 |demo-gvc-identity |cpln-demo-cpln-organi-58qrarzx |0 minutes ago |          |              |
+--------------------+--------------------+------------------+-------------------------------+--------------+----------+--------------+
```
...
|NAME          |DESCRIPTION   |GVC               |LOCAL NAME                     |CREATED       |PROVIDERS |TAGS           |
|--------------|--------------|------------------|-------------------------------|--------------|----------|---------------|
|demo-identity |demo-identity |demo-gvc-identity |cpln-demo-cpln-organi-42yth1jf |5 minutes ago |          |drink="coffee" |
+--------------+--------------+------------------+-------------------------------+--------------+----------+---------------+
```
...
|NAME          |DESCRIPTION   |GVC               |LOCAL NAME                     |CREATED       |PROVIDERS |TAGS |
|--------------|--------------|------------------|-------------------------------|--------------|----------|-----|
|demo-identity |demo-identity |demo-gvc-identity |cpln-demo-cpln-organi-42yth1jf |5 minutes ago |          |     |
+--------------+--------------+------------------+-------------------------------+--------------+----------+-----+
```
...
|NAME                 |DESCRIPTION          |GVC               |LOCAL NAME                     |CREATED       |PROVIDERS |TAGS |
|---------------------|---------------------|------------------|-------------------------------|--------------|----------|-----|
|demo-identity-update |demo-identity-update |demo-gvc-identity |cpln-demo-cpln-organi-bs35s9c8 |0 minutes ago |          |     |
+---------------------+---------------------+------------------+-------------------------------+--------------+----------+-----+
```
...
|NAME                 |DESCRIPTION     |GVC               |LOCAL NAME                     |CREATED       |PROVIDERS |TAGS |
|---------------------|----------------|------------------|-------------------------------|--------------|----------|-----|
|demo-identity-update |new description |demo-gvc-identity |cpln-demo-cpln-organi-bs35s9c8 |0 minutes ago |          |     |
+---------------------+----------------+------------------+-------------------------------+--------------+----------+-----+
```
...
|NAME                 |DESCRIPTION     |GVC               |LOCAL NAME                     |CREATED       |PROVIDERS |TAGS                  |
|---------------------|----------------|------------------|-------------------------------|--------------|----------|----------------------|
|demo-identity-update |new description |demo-gvc-identity |cpln-demo-cpln-organi-bs35s9c8 |0 minutes ago |          |demo-key="demo-value" |
+---------------------+----------------+------------------+-------------------------------+--------------+----------+----------------------+
```
...
|superusers-ipset           |Built-in policy granting full access ... |6 months ago  |ipset           |all     |builtin |              |
...
|viewers-ipset              |Built-in policy granting read-only ac... |6 months ago  |ipset           |all     |builtin |              |
...
|2e3172b8-b81c-4d8c-a26b-68835fe55eca |workloads-per-gvc     |Max number of workloads in a gvc         |builtin |1       |20   |count     |gvcLink="demo-gvc-workload"       |
...
|7192701c-0c3e-4e5e-8cad-5e1cbea4495a |identities-per-gvc    |Max number of workload identities in ... |builtin |4       |20   |count     |gvcLink="demo-gvc-identity"       |
...
|a35002c8-add4-4128-bf1e-eb5f99edb81f |workloads-per-gvc     |Max number of workloads in a gvc         |builtin |0       |20   |count     |gvcLink="demo-gvc-with-workloads" |
...
```text Output
{
  ...
  "created": "2025-05-09T17:50:31.671Z",
  "key": "s5SPT0S93kmz3Bx8.ZGVtby1jcGxuLW9yZ2FuaXphdGlvbi5kZW1vLXNlcnZpY2UtYWNjb3VudC5LbWpSdHdXbi9nc0haOWFBTDI5NjVuNmNGbitjUFVaekZrRWdjaVhiYXlJPQ.3ld4eb0dDY86xwuDiJQaWc5DJEHAlk_nzhIbcRCWaIQ"
}
```
...
|demo-service-account       |demo-service-account                     |9 minutes ago |default |s5SPT0S93kmz3Bx8 |drink="water" |
...
```bash Command
cpln serviceaccount remove-key demo-service-account --key sfjLwWDNbQllFOHc --org demo-cpln-organization
```
...
|NAME                |DESCRIPTION            |GVC               |READY     |CREATED       |ENDPOINT                                             |TAGS          |
|--------------------|-----------------------|------------------|----------|--------------|-----------------------------------------------------|--------------|
|demo-workload-clone |Clone of demo-workload |demo-gvc-workload |          |0 minutes ago |https://demo-workload-clone-wv64zc0za55qw.t.cpln.app |drink="water" |
+--------------------+-----------------------+------------------+----------+--------------+-----------------------------------------------------+--------------+
```
...
|NAME          |DESCRIPTION   |GVC               |READY     |CREATED       |ENDPOINT                                       |TAGS          |
|--------------|--------------|------------------|----------|--------------|-----------------------------------------------|--------------|
|demo-workload |demo-workload |demo-gvc-workload |          |0 minutes ago |https://demo-workload-wv64zc0za55qw.t.cpln.app |drink="water" |
+--------------+--------------+------------------+----------+--------------+-----------------------------------------------+--------------+
```
...
|NAME                |DESCRIPTION         |GVC               |READY |CREATED        |ENDPOINT                                             |TAGS          |
|--------------------|--------------------|------------------|------|---------------|-----------------------------------------------------|--------------|
|demo-workload-get-1 |demo-workload-get-1 |demo-gvc-workload |false |0 minutes ago  |https://demo-workload-get-1-wv64zc0za55qw.t.cpln.app |              |
|demo-workload-get-2 |demo-workload-get-2 |demo-gvc-workload |false |0 minutes ago  |https://demo-workload-get-2-wv64zc0za55qw.t.cpln.app |              |
|demo-workload       |demo-workload       |demo-gvc-workload |false |11 minutes ago |https://demo-workload-wv64zc0za55qw.t.cpln.app       |drink="water" |
+--------------------+--------------------+------------------+------+---------------+-----------------------------------------------------+--------------+
```
...
|NAME                |DESCRIPTION         |GVC               |READY     |CREATED        |ENDPOINT                                             |TAGS          |
|--------------------|--------------------|------------------|----------|---------------|-----------------------------------------------------|--------------|
|demo-workload-get-1 |demo-workload-get-1 |demo-gvc-workload |          |0 minutes ago  |https://demo-workload-get-1-wv64zc0za55qw.t.cpln.app |              |
|demo-workload-get-2 |demo-workload-get-2 |demo-gvc-workload |          |0 minutes ago  |https://demo-workload-get-2-wv64zc0za55qw.t.cpln.app |              |
|demo-workload       |demo-workload       |demo-gvc-workload |          |11 minutes ago |https://demo-workload-wv64zc0za55qw.t.cpln.app       |drink="water" |
+--------------------+--------------------+------------------+----------+---------------+-----------------------------------------------------+--------------+
```
...
|NAME                |DESCRIPTION         |GVC               |READY     |CREATED       |ENDPOINT                                             |TAGS          |
|--------------------|--------------------|------------------|----------|--------------|-----------------------------------------------------|--------------|
|demo-workload-tag-1 |demo-workload-tag-1 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-1-wv64zc0za55qw.t.cpln.app |drink="water" |
+--------------------+--------------------+------------------+----------+--------------+-----------------------------------------------------+--------------+
```
...
|NAME                |DESCRIPTION         |GVC               |READY     |CREATED       |ENDPOINT                                             |TAGS           |
|--------------------|--------------------|------------------|----------|--------------|-----------------------------------------------------|---------------|
|demo-workload-tag-1 |demo-workload-tag-1 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-1-wv64zc0za55qw.t.cpln.app |drink="coffee" |
+--------------------+--------------------+------------------+----------+--------------+-----------------------------------------------------+---------------+
```
...
|NAME                |DESCRIPTION         |GVC               |READY     |CREATED       |ENDPOINT                                             |TAGS |
|--------------------|--------------------|------------------|----------|--------------|-----------------------------------------------------|-----|
|demo-workload-tag-1 |demo-workload-tag-1 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-1-wv64zc0za55qw.t.cpln.app |     |
+--------------------+--------------------+------------------+----------+--------------+-----------------------------------------------------+-----+
```
...
|NAME                |DESCRIPTION         |GVC               |READY     |CREATED       |ENDPOINT                                             |TAGS                      |
|--------------------|--------------------|------------------|----------|--------------|-----------------------------------------------------|--------------------------|
|demo-workload-tag-1 |demo-workload-tag-1 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-1-wv64zc0za55qw.t.cpln.app |multiple-workloads="true" |
|demo-workload-tag-2 |demo-workload-tag-2 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-2-wv64zc0za55qw.t.cpln.app |multiple-workloads="true" |
+--------------------+--------------------+------------------+----------+--------------+-----------------------------------------------------+--------------------------+
```
...
|NAME                |DESCRIPTION         |GVC               |READY     |CREATED       |ENDPOINT                                             |TAGS                               |
|--------------------|--------------------|------------------|----------|--------------|-----------------------------------------------------|-----------------------------------|
|demo-workload-tag-1 |demo-workload-tag-1 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-1-wv64zc0za55qw.t.cpln.app |multiple-workloads="demo-workload" |
|demo-workload-tag-2 |demo-workload-tag-2 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-2-wv64zc0za55qw.t.cpln.app |multiple-workloads="demo-workload" |
+--------------------+--------------------+------------------+----------+--------------+-----------------------------------------------------+-----------------------------------+
```
...
|--------------------|--------------------|------------------|----------|--------------|-----------------------------------------------------|-----|
|demo-workload-tag-1 |demo-workload-tag-1 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-1-wv64zc0za55qw.t.cpln.app |     |
|demo-workload-tag-2 |demo-workload-tag-2 |demo-gvc-workload |          |0 minutes ago |https://demo-workload-tag-2-wv64zc0za55qw.t.cpln.app |     |
+--------------------+--------------------+------------------+----------+--------------+-----------------------------------------------------+-----+
```
...
|NAME                 |DESCRIPTION          |GVC               |READY     |CREATED       |ENDPOINT                                              |TAGS |
|---------------------|---------------------|------------------|----------|--------------|------------------------------------------------------|-----|
|demo-workload-update |demo-workload-update |demo-gvc-workload |          |0 minutes ago |https://demo-workload-update-wv64zc0za55qw.t.cpln.app |     |
+---------------------+---------------------+------------------+----------+--------------+------------------------------------------------------+-----+
```
...
|NAME                 |DESCRIPTION     |GVC               |READY     |CREATED       |ENDPOINT                                              |TAGS |
|---------------------|----------------|------------------|----------|--------------|------------------------------------------------------|-----|
|demo-workload-update |new description |demo-gvc-workload |          |0 minutes ago |https://demo-workload-update-wv64zc0za55qw.t.cpln.app |     |
+---------------------+----------------+------------------+----------+--------------+------------------------------------------------------+-----+
```
...
|NAME                 |DESCRIPTION     |GVC               |READY     |CREATED       |ENDPOINT                                              |TAGS                  |
|---------------------|----------------|------------------|----------|--------------|------------------------------------------------------|----------------------|
|demo-workload-update |new description |demo-gvc-workload |          |0 minutes ago |https://demo-workload-update-wv64zc0za55qw.t.cpln.app |demo-key="demo-value" |
+---------------------+----------------+------------------+----------+--------------+------------------------------------------------------+----------------------+
```
