...
description: Configure JWT providers, claim-to-header mappings, and rules to validate and authenticate JSON Web Tokens in HTTP requests to workloads.
keywords: ['oidc', 'oauth2', 'token validation', 'bearer token', 'jwks', 'auth0', 'okta', 'cognito', 'firebase auth', 'auth header', 'rs256', 'verify token', 'claims']
---
