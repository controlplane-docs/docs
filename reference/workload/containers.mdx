...
- A public registry
  ...
  - If authentication is required, a [pull secret](/reference/gvc#pull-secrets) must be configured on the [Global Virtual Cloud (GVC)](/concepts/gvc) containing the [workload](/concepts/workload).
