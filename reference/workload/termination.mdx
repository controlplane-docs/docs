...
**Serverless workloads**: For serverless workloads, the termination grace period is currently limited by the [timeoutSeconds](/reference/workload/general#timeout-seconds) in workload options. This restriction will be removed in a future update.
