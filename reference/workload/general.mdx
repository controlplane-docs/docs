...
Each workload can allowed to receive requests from other workloads in the same Org internally using the provided intenal endpoint. Access to this endpoint is controller by the internal firewall settings.
