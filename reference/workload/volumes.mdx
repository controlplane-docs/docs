---
title: Volumes
description: Mount cloud object storage, file storage, ephemeral scratch storage, and secrets to workload containers at runtime.
keywords: ['s3', 'gcs', 'azure blob', 'efs', 'nfs', 'tmpfs', 'volume mount path', 'object storage uri', 'mount secret', 'secret as file', 'shared volume', 'cpln volume']
---
