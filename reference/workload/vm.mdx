...
| **Identity & cloud access** | The VM uses the workload's [identity](/reference/identity); cloud‑provider credentials are available to the guest via the same metadata endpoint used by containers. |
