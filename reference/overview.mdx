...
<CardGroup cols={2}>
  ...
  <Card title="Workload" icon="cube" href="/reference/workload/general">
    Your applications running as serverless, standard, cron, or stateful deployments with autoscaling and load balancing.
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Identity" icon="fingerprint" href="/reference/identity">
    Credential-free access to cloud resources and private networks via workload identity federation with AWS, GCP, and Azure.
  </Card>
</CardGroup>
...
Resources for managing credentials and container images.
...
Resources for tracking activity and maintaining compliance.

<CardGroup cols={2}>
  <Card title="Audit Context" icon="scroll" href="/reference/auditctx">
    Tamper-proof audit trails for Control Plane actions and custom workload events.
  </Card>
</CardGroup>
