...
After successful authentication, users' access privileges are determined based on their assigned [group membership](/api-reference/group) or [policy](/api-reference/policy).

## [Security Assertion Markup Language (SAML) Configuration](#saml-configuration)
