...
<Note>
The mirrored workload must be in the same cluster as the main workload.
</Note>
...
**Certificate Challenge Types:**
- `certChallengeType: dns01`: Uses DNS-01 challenge for certificate validation (only supported option)
...
To view the CLI documentation for domains, [click here](/cli-reference/commands/domain).
