...
<CardGroup cols={2}>
  <Card title="Understand the model" href="/concepts/org" icon="lightbulb">
    How orgs, Global Virtual Clouds, workloads, and access control nest inside each other.
  </Card>
  <Card title="Do a task" href="/guides/overview" icon="book-open">
...
<CardGroup cols={2}>
  ...
  <Card title="CPLN BYOK" href="/byok/overview" icon="cloud">
...
<CardGroup cols={3}>
  <Card title="Logs" href="/core/logs" icon="file-lines">
  ...
  <Card title="Tracing" href="/reference/gvc#tracing" icon="diagram-project">
