...
<CardGroup cols={2}>
  <Card title="Quickstart Guides" href="/quickstart/sample-application" icon="play">
...
<CardGroup cols={3}>
  ...
  <Card title="Create Workloads" href="/guides/create-workload" icon="server">
    Deploy containerized applications
  </Card>
  <Card title="Configure Domains" href="/guides/configure-domain" icon="link">
    Set up custom domains and routing
  </Card>
  <Card title="Push Images" href="/guides/push-image" icon="docker">
    Push container images to the registry
  </Card>
  <Card title="Manage Secrets" href="/reference/secret" icon="key">
    Securely store and access sensitive data
  </Card>
  <Card title="Set Up Policies" href="/guides/policy" icon="shield">
...
<CardGroup cols={3}>
  ...
  <Card title="BYOK Platform" href="/byok/overview" icon="cloud">
    Bring Your Own Kubernetes to Control Plane
  </Card>
  <Card title="Agents" href="/guides/agent" icon="tower-broadcast">
...
<CardGroup cols={2}>
  <Card title="Terraform" href="/terraform/installation" icon="file-code">
    Infrastructure as Code
  </Card>
  <Card title="Pulumi" href="/pulumi/installation" icon="file-code">
...
<CardGroup cols={3}>
  ...
  <Card title="Identity & Access" href="/reference/identity" icon="id-badge">
    Cloud identities and workload access
  </Card>
