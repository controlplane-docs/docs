...
description: 'Provision a Managed Kubernetes cluster on Triton Private Cloud with a manifest, including the required manual load balancer, node pools, and syslog logging.'
keywords: ['mk8s', 'triton-moirai', 'kubeconfig', 'kubectl', 'node pool', 'datacenter', 'externalSyslog', 'nodePort', 'headlamp', 'cpln.io/refreshToken', 'instance rotation', 'on-prem']
---
