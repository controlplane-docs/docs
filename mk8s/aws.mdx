---
title: AWS Provider
description: Configure and deploy Managed Kubernetes clusters on AWS with automated node scaling, load balancer provisioning, version upgrades, and storage management.
keywords: ['mk8s', 'k8s on aws', 'eks alternative', 'amazon', 'vpc', 'ec2', 'iam role', 'spot instance', 'asg', 'auto scaling group', 'subnets', 'eks']
---
