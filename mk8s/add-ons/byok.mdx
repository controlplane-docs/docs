---
title: CPLN Platform
description: Turn your Managed Kubernetes cluster into a BYOK location by enabling the CPLN Platform add-on for centralized management through Control Plane.
keywords: ['mk8s', 'self-hosted', 'bring your own kubernetes', 'cluster integration', 'register cluster', 'cluster onboarding', 'platform add-on']
---
...
- **Using the Console**: If you're creating the cluster through the console, navigate to `Add-ons` in the left pane, find the `CPLN Platform` add-on in the list of available add-ons, and toggle it on.
