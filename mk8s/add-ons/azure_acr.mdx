...
keywords: ['image pull', 'image pull secret', 'private registry', 'mk8s', 'azure ad', 'service principal', 'docker registry']
---
...
- **Using the Console**: If you're creating the cluster through the console, navigate to `Add-ons` in the left pane, find the `Azure ACR` add-on in the list of available add-ons, and toggle it on.
