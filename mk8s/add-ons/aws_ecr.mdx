...
Skip this step if you have already created the provider as part of the [AWS Workload Identity configuration](aws_workload_identity#steps-to-configure-access).
