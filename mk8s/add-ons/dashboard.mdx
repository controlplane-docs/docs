---
title: Kubernetes Dashboard (Deprecated)
...
keywords: ['mk8s', 'k8s ui', 'cluster gui', 'pod viewer', 'cluster console', 'browser dashboard', 'kubernetes dashboard', 'addOns dashboard']
---

<Warning>
  This add-on is deprecated, we suggest using [Headlamp](/mk8s/add-ons/headlamp).
</Warning>
