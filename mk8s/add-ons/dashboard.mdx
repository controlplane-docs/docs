...
The Kubernetes Dashboard add-on provides a user-friendly interface, enabling users to manage and monitor their Kubernetes
clusters directly from a web interface. This add-on simplifies cluster management tasks and offers a comprehensive view of the cluster's state.
...
The Dashboard add-on can be enabled for your Kubernetes cluster either during the cluster creation process or at any time thereafter.
