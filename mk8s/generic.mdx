...
The Generic provider for Managed Kubernetes allows Linux-based servers to be converted into worker nodes of a Kubernetes cluster, irrespective
of their deployment in public clouds (such as AWS, Azure, GCP, Hetzner, etc.) or in private cloud / on-premises environments.
Once integrated, these servers join a Kubernetes cluster as worker nodes, enabling the deployment of Kubernetes workloads through the Kubernetes API.
...
## [Step 1 - Servers Setup](#servers-setup)
...
## [Step 2 - Creating Managed Kubernetes Cluster with Manifest](#creating-managed-kubernetes-cluster-with-manifest)
...
## [Step 3 - Connecting the Server(s) to the Cluster](#connecting-the-servers-to-the-cluster)
...
## [Step 4 - Accessing the Cluster](#accessing-the-cluster)
...
### [2. Using Kubernetes Dashboard](#using-kubernetes-dashboard)
