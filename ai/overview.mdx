...
icon: compass
description: Two paths, the AI Plugin for Claude Code, Codex, and Antigravity CLI, or the MCP Server for any other client, already listed in Claude and ChatGPT.
keywords: ['ai agents', 'ai plugin', 'mcp server', 'claude', 'chatgpt', 'codex', 'antigravity', 'cursor', 'overview', 'recommended']
---

<CardGroup cols={2}>
  <Card title="AI Plugin (Recommended)" icon="puzzle-piece" href="/ai/plugin">
  ...
  <Card title="MCP Server" icon="/icons/mcp.svg" href="/ai/mcp">
    For **any other MCP-compatible AI**: Cursor, Claude Web, Claude Desktop, ChatGPT, VS Code, Antigravity IDE, Amp, OpenCode. Claude and ChatGPT connect from their own directories, with no URL to enter.
  </Card>
</CardGroup>
...
<CardGroup cols={3}>
  <Card title="Claude Code" icon="/icons/claude.svg" href="/ai/plugin">
    **AI Plugin** · [MCP only](/ai/claude)
  </Card>
  <Card title="Codex" icon="/icons/codex.svg" href="/ai/plugin">
    **AI Plugin** · [All surfaces](/ai/codex)
  </Card>
  <Card title="Antigravity CLI" icon="/icons/antigravity.png" href="/ai/plugin">
  ...
  <Card title="Antigravity IDE" icon="/icons/antigravity.png" href="/ai/antigravity">
    MCP Server
  </Card>
  ...
  <Card title="Other MCP clients" icon="/icons/mcp.svg" href="/ai/mcp">
