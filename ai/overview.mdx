...
icon: compass
description: Two paths — the AI Plugin for Claude Code, Codex, and Antigravity CLI, or the MCP Server for any other MCP-compatible client.
keywords: ['ai agents', 'ai plugin', 'mcp server', 'claude', 'codex', 'antigravity', 'cursor', 'overview', 'recommended']
---
