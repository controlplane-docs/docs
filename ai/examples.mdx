...
This page provides practical examples of how to interact with Control Plane through AI assistants using the MCP Server. These examples work across all [compatible tools](/ai/mcp-server#compatible-tools).
...
<CardGroup cols={2}>
  <Card title="Tool Setup" icon="gear" href="/ai/mcp-server">
