...
description: Configure the BYOK actuator component that processes Control Plane events to manage Kubernetes deployments, routing, and storage on your cluster.
keywords: ['cpln-byok-current', 'configmap', 'environment variables', 'ingress request', 'cpu request', 'memory request', 'autoscaler target', 'load balancer ingress', 'kube-system', 'millicores']
---
