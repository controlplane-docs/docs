...
description: BYOK-specific workload settings including internal firewall configuration for private address ranges and extra Kubernetes options.
keywords: ['affinity', 'tolerations', 'topology spread', 'k8s extras', 'cidr', 'rfc1918', 'private network', 'ingress rules', 'internal subnet', 'pod scheduling']
---
