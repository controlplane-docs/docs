...
A group is a membership collection that can contain [users](/objects/user) and [service accounts](/objects/serviceaccount). It is one of the [principal types](/platform/access-control) of an [org](/objects/org).
