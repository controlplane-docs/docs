...
Agents are scoped to an [org](/objects/org) and are used in conjunction with [identities](/objects/identity) to set up [network resources](/objects/identity#network-resources-cloud-wormhole).
