...
An Org serves as a tightly isolated bounded context that encompasses all the resources managed by Control Plane. These resources comprise [domains](/objects/domain), [images](/objects/image), [workloads](/objects/workload), [GVCs](/objects/gvc), [users](/objects/user), [groups](/objects/group), [service accounts](/objects/serviceaccount), and more.
...
Please [click here](/objects/org/external-logging/overview) for additional details and configuration instructions.
...
default setting (for [PCI compliance](/platform/compliance#pci)) and can be modified.
