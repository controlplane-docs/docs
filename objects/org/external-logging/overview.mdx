...
When logs are shipped to an external provider, all logs will remain accessible through Control Plane, adhering to the [current log retention policy](/platform/logs#log-retention).
