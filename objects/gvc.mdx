...
When creating a GVC you are in essence building an uber-cloud that is comprised of the specified locations. [Workloads](/concepts/workload) are deployed to the GVC which are then served from all the locations specified.
