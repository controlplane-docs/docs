...
Once the bootstrap config file has been generated and saved, follow the [set up an agent](/guides/configure-resources/setup-agent) guide to install and configure an agent:
...
- [Private Network](/guides/configure-resources/setup-agent#private-network)
