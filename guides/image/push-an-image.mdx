...
In situations where the [CLI](/reference/cli) cannot be used, authentication to your private [image registry](/reference/image) is achieved by using a [Service Account](/guides/create-serviceaccount).
...
- Password: `Service Account Key`
  <Note>Refer to the [Create a Service Account](/guides/create-serviceaccount) guide for instructions on how to generate a new key.</Note>
