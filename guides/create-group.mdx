...
3. Click `Users` in the left resource menu. Click `Add User` to view a list of [users](/reference/user) will be shown that can be selected. A [query](/reference/group#query-rules) can be defined to dynamically assign users to the group. Click `Ok` to continue.
4. Click `Service Accounts` in the left resource menu. Click `Add Service Accounts` to view a list of [service accounts](/reference/serviceaccount) will be shown that can be selected.
