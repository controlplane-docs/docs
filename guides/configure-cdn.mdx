...
- Click the `New` button at the top.
- Click `Advanced` in the left pane. Enter the `Fully Qualified Domain Name (FQDN)` of your Domain. You will need to prove ownership of the domain before continuing.
