...
6. Click the `Add +` tab, and toggle the `Use Custom Server Certificate` and set the `Server Certificate Authority PEM` to the [TLS Secret](/reference/secret#tls) created in the step above then click `Create`.
