...
## Control Plane Default Locations

These are the default metrics available in Control Plane's Grafana instance for each organization (Org).
These metrics provide insights into various aspects of your organization's performance and resource utilization.
