...
1. Refer to the [Create a Workload](/guides/create-resources/create-workload) guide and [workload](/reference/workload) reference page to create/manage your workload.
