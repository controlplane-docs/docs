...
1. Create a new cloud account by either:
   - Click `Cloud Accounts` in the left menu and click `New`, or
...
3. Under `Cloud Provider`, select the provider you are targeting.
   - The UI will show instruction on how to obtain the ID for your account at the selected cloud provider.
4. Click `Provider` in the left pane, Copy and paste the ID into the textbox beneath the instructions.
...
6. Click `Tags` in the left pane, enter any optional [tags](/core/misc#tags). Click `Create`.
7. Your cloud account has been successfully created and connected to the cloud provider.
