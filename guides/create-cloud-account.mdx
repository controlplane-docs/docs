...
4. Click `Provider` in the left resource menu, Copy and paste the ID into the textbox beneath the instructions.
...
7. Click `Tags` in the left resource menu, enter any optional [tags](/core/misc#tags). Click `Create`.
