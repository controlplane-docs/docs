...
4. Click `Provider` in the left pane, Copy and paste the ID into the textbox beneath the instructions.
   - The UI shows instruction on how to obtain the ID for your account for the selected cloud provider.
...
7. Click `Create`, your cloud account has been successfully created and connected to the cloud provider.
