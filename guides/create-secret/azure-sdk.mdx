---
title: Azure SDK
description: Create an Azure SDK secret to store service principal credentials for authenticating workloads with Azure services.
keywords: ['azure ad', 'service principal', 'spn', 'tenant id', 'client id', 'client secret', 'azure auth', 'msi', 'azure cli auth', 'app registration']
---
