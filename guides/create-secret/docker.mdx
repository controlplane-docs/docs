---
title: Docker
description: Create a Docker secret to store container registry credentials for pulling images from private registries like Docker Hub, GHCR, or ACR.
keywords: ['imagepullsecrets', 'pull secret', 'dockerconfigjson', 'private registry auth', 'ghcr', 'quay', 'gitlab registry', 'jfrog artifactory', 'harbor']
---
