...
description: Create an Azure Connector secret to store credentials for connecting to Azure Function Apps from Control Plane workloads.
keywords: ['azure functions', 'function app credentials', 'serverless azure', 'webhook integration', 'azure trigger', 'function key', 'azure secret', 'durable functions', 'function url']
---
