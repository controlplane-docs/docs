...
Choose from any of the four methods below to create a TLS secret:
...
3. Select **TLS** as the secret type.
4. Click **Data** in the left pane.
5. For **TLS Key**, drag and drop your private key file or click to import.
6. For **TLS Cert**, drag and drop your certificate file or click to import.
7. For **TLS Chain** (optional), drag and drop your certificate chain file or click to import.
8. Click **Create**.
...
<Tip>
If you have a PKCS#12 (.p12/.pfx) file, convert it to PEM format using OpenSSL:
