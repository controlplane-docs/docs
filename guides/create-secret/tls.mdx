---
title: TLS
description: Create a TLS secret to store SSL/TLS certificates and private keys for custom domains, mTLS authentication, or secure communication.
keywords: ['ssl certificate', 'pem cert', 'crt', 'private key', 'cert chain', 'wildcard cert', 'lets encrypt cert', 'ca bundle', 'tls secret']
---
