...
description: Create a username and password secret to store authentication credentials for databases, APIs, SMTP servers, or other services.
keywords: ['basic auth', 'login credentials', 'db login', 'postgres password', 'mysql password', 'mongo credentials', 'smtp credentials', 'ftp credentials', 'cred pair']
---
