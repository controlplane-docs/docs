---
title: Keypair
description: Create a keypair secret to store asymmetric public and private keys for SSH authentication, JWT signing, or encryption.
keywords: ['rsa key', 'ed25519', 'ecdsa', 'pem', 'pkcs8', 'jwt rs256', 'pgp', 'gpg key', 'passphrase', 'ssh key secret']
---
