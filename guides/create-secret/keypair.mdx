...
Choose from any of the four methods below to create a Keypair secret:
...
3. Select **Keypair** as the secret type.
4. Click **Data** in the left pane.
5. For **Secret Key**, drag and drop your private key file or click to import.
6. For **Public Key**, drag and drop your public key file or click to import.
7. Enter the **Passphrase** if the private key is encrypted (optional).
8. Click **Create**.
...
data:
  secretKey: |
    ...
    MIIEowIBAAKCAQEA0Z3VS5JJcds3xfn/ygWyF8PbnGy0AHB7MhgHrOoNhHcrqfgg
    ...
    -----END RSA PRIVATE KEY-----
  publicKey: |
    -----BEGIN PUBLIC KEY-----
