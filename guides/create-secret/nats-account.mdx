---
title: NATS Account
description: Create a NATS Account secret to store NKey-based credentials for authenticating workloads with NATS clusters or NGS.
keywords: ['nats global service', 'synadia', 'jetstream auth', 'pubsub broker', 'nkey seed', 'nats jwt', 'nats credentials', 'account id', 'nats nkey']
---
...
<CardGroup cols={2}>
  <Card title="Cloud Accounts" icon="/icons/cloud-account.svg" href="/reference/cloudaccount">
