...
description: "Create and manage encrypted secrets for workloads. Covers secret types, workload injection methods, pull secret configuration, and CLI/Console workflows."
keywords: ['vault', 'kms', 'secret manager', 'cpln secret create', 'env injection', 'mount secret', 'secret kinds', 'sensitive data', 'credentials store']
---
