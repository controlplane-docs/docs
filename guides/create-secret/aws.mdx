---
title: AWS
description: Create an AWS secret to store IAM credentials for authenticating workloads with AWS services like S3, DynamoDB, and SQS.
keywords: ['aws access key', 'aws secret key', 'aws credentials', 'iam user keys', 'amazon credentials', 'access key id', 'aws_access_key_id', 'env var aws', 'long lived keys']
---
