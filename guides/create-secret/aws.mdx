...
Choose from any of the four methods below to create an AWS secret:
...
3. Select **AWS** as the secret type.
4. Click **Data** in the left pane.
5. Enter the **Access Key** and **Secret Key**.
6. Optionally enter a **Role ARN** and **External ID** for role assumption.
7. Click **Create**.
