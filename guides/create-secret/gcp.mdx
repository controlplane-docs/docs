---
title: GCP
description: Create a GCP secret to store Google Cloud service account credentials for authenticating with GCP services or pulling images from Artifact Registry.
keywords: ['gcr', 'gar', 'service account json', 'sa key file', 'gcp credentials', 'gcr login', 'pull from gcr', 'gcr image', 'workload identity gcp']
---
