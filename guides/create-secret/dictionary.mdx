---
title: Dictionary
description: Create a dictionary secret to store multiple key-value pairs in a single secret, ideal for grouping related configuration values.
keywords: ['key value secret', 'env bundle', 'config map alternative', 'multi-key secret', 'k8s configmap', 'env vars secret', 'json secret', 'env file']
---
