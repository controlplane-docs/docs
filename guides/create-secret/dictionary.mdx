...
Choose from any of the four methods below to create a Dictionary secret:
...
3. Select **Dictionary** as the secret type.
4. Click **Data** in the left pane.
5. Click **Add** to add key-value pairs, or drag and drop a file / click to import.
6. Click **Create**.
