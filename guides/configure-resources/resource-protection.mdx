...
The Control Plane platform will prevent the deletion of resources with the `cpln/protected` [tag](/api-reference/misc#tags) set to `true`.
...
## [Using the Console UI](#console-ui)
