...
For example, in the development [Org](/reference/org), you could apply nearly the same YAML manifest files (used by [cpln apply](/cli-reference/guides/cpln-apply)) as the production [Org](/reference/org) with different content for your secrets.
