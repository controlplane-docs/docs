...
Part 4 of the quickstart, [Service-to-service communication](/quickstart/quick-start-4-service-to-service), builds an internal API, shows the default deny from the caller's side, and allows the caller on the API's workload list.
