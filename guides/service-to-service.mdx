...
Part 3 of the quickstart, [Service-to-service communication](/quickstart/connect-workloads), builds an internal API, shows the default deny from the caller's side, and allows the caller on the API's workload list.
