...
- Review the [Quota](/concepts/quota) concept page and the [Quota reference](/reference/quota).
...
[
  {
    ...
    "description": "Max number of workloads in a gvc",
    "unit": "count",
    "max": 50,
    "current": 32,
    "origin": "default"
...
- Learn how quotas and increase requests work in the [Quota](/concepts/quota) concept page.
