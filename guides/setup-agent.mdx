...
```
gcloud compute instances create **INSTANCE_NAME** --image controlplane-agent-amd64-20250820-1994640923-ccd08d6b --image-project cpln-build --metadata-from-file=user-data=**AGENT_NAME-bootstrapConfig.json**
```
