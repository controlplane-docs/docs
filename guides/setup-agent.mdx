...
```
gcloud compute instances create **INSTANCE_NAME** --image controlplane-agent-amd64-20251126-2179681158-83321dd5 --image-project cpln-build --metadata-from-file=user-data=**AGENT_NAME-bootstrapConfig.json**
```
