...
```
gcloud compute instances create **INSTANCE_NAME** --image controlplane-agent-amd64-20251010-2092123647-588f5b90 --image-project cpln-build --metadata-from-file=user-data=**AGENT_NAME-bootstrapConfig.json**
```
