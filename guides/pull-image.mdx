...
keywords: ['imagepullsecrets', 'pull secret', 'docker pull', 'private docker hub', 'ghcr pull', 'ecr pull', 'gcr pull', 'cross-cloud pull', 'image pull error']
---
...
<Step title="Create a pull secret">
  ...
  <Tab title="Console">
    ...
    5.  Click `Data` in the left pane, Enter the credentials
    6. Click **Create**
  </Tab>
...
<Step title="Associate with a GVC">
  ...
  <Tab title="Console">
    ...
    3. Click **Add Pull Secret** and select your secret
    4. Click **Update**
  </Tab>
