...
description: "Create a Google Cloud SQL instance with Private Service Connect (PSC) for secure private connectivity to Control Plane workloads."
keywords: ['gcp postgres', 'gcp mysql', 'cloudsql private', 'tf module', 'hcl', 'private database', 'no public ip db', 'cloud sql proxy']
---
