...
3. Click `Tags` in the left pane, and enter any optional [tags](/core/misc#tags). Click `Create`.
4. Click the `Keys` in the left pane to generate a new token that is used to create a profile.
