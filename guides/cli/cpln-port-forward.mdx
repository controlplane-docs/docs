...
<Info>
  You can **port-forward to workloads that are not actively serving traffic**. This allows you to establish a connection even if no
  container is currently bound to the specified port.
</Info>
