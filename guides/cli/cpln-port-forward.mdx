...
The [cpln port-forward](/reference/cli#port-forward) command securely connects your local machine with resources running within a workload, such as databases or internal services, enabling private and secure interaction without the need for public exposure.
