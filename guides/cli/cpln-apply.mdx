...
- Before creating a [cloud account](/reference/cloudaccount), additional configuration is required at the target cloud provider. Refer to the [Create Cloud Account](/guides/create-resources/create-cloud-account) guide for instructions.
- Before creating a [domain](/reference/domain), the required DNS entries must exist. Refer to the [Configure a Domain](/guides/configure-resources/configure-domain#required-dns-records) guide for instructions.
...
Refer to the [GitOps CLI](/guides/gitops/gitops#cli) documentation for additional information.
