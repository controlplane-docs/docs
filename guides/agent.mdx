...
4. Click `Create`. The console will display the bootstrap config JSON. Manually save the JSON or click `Download Config File`. 
...
Once the bootstrap config file and/or scripts have been generated and saved, follow the [set up an agent](/guides/setup-agent) guide to install and configure an agent:
