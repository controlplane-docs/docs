...
3. Optional: Click `Tags` in the left menu. Enter any optional [tags](/core/misc#tags).
...
Detailed CLI documentation for the agent command is available [here](/cli-reference/commands/agent).
