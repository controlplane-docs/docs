...
4. Click `Create`, the console will display the bootstrap config JSON text. Manually save the JSON or click `Download Config File` Once saved, click `Next`. This file will be used when configuring an agent. Review the script details and Click `Done`.
