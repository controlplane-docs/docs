...
sidebarTitle: Metrics Management
description: Access metrics from multiple orgs using a centralized Grafana instance by adding Prometheus data sources across organizations.
keywords: ['multi-org metrics', 'grafana datasource', 'cross-org dashboard', 'observability', 'prometheus federation', 'metrics aggregation', 'unified dashboard', 'readMetrics', 'bearer token']
---
