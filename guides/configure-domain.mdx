...
Follow Step One in the [domain quick start](/quickstart/quick-start-3-custom-domain#step-1-register-your-apex-domain) to create and verify the apex domain name using the Console UI.
...
Follow Step Two in the [domain quick start](/quickstart/quick-start-3-custom-domain#step-2-configure-your-subdomain) for detailed instructions on how to create and configure your domain name using the Console UI.
