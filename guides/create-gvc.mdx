...
<Note>
The locations you select are not limited to public cloud regions. Bare-metal servers, on-premises VMs, and your own Kubernetes clusters can be registered as [locations](/reference/location) and added to a GVC alongside cloud regions. See [Deploy a Workload to Your Own Hardware](/guides/deploy-to-your-own-hardware).
</Note>
