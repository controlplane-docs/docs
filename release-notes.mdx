...
- CLI
  ...
  - Version Info
    - npm: **2.2.2**
  - [Installation Instructions](/api-reference/cli#instruction)

## [Known Issues](#known-issues)

- CLI
  - Windows
    - [Autocomplete](/api-reference/cli#autocomplete) functionality is not available. A [workaround](/api-reference/cli#autocomplete) is available for `cygwin`.

## [CLI v2.2.2 Release](#cli-2.2.2)
