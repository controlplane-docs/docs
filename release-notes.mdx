...
- **Major Changes:**
  ...
  - Refactor of [cpln workload exec](/reference/cli#workload-exec) command:

    The [cpln workload exec](/reference/cli#workload-exec) command has been updated to align with the functionality of [kubectl exec](https://kubernetes.io/docs/reference/kubectl/generated/kubectl_exec/).
    ...
    For more details, refer to the [cpln workload exec guide](/guides/cli/workload/exec).
